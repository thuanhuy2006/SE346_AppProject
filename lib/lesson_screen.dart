...
class _LessonScreenState extends State<LessonScreen> {
  ...
  List<Map<String, dynamic>> _getCb1LuyenTap3Data() {
    return [
      ...
      },
      {
        ...
        'question': 'Trợ từ "Cũng" trong tiếng Nhật là gì?',
        'options': ['は (wa)', 'も (mo)', 'の (no)', 'か (ka)'],
        'answer': 'も (mo)',
      },
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ "Của" (Sở hữu) trong tiếng Nhật là gì?',
        'options': ['は (wa)', 'も (mo)', 'の (no)', 'か (ka)'],
        'answer': 'の (no)',
      },
      {
        'type': LessonType.listening,
        'options': ['だれ', 'どなた', 'あのひと', 'あのかた'],
        'answer': 'どなた',
      },
      {
        'type': LessonType.listening,
        'options': ['なんさい', 'おいくつ', 'だれ', 'どなた'],
        'answer': 'おいくつ',
      },
      {
        ...
        'pairs': [
          {'left': 'Tôi', 'right': 'わたし'},
          {'left': 'Cũng', 'right': 'も (mo)'},
          {'left': 'Của', 'right': 'の (no)'},
          {'left': 'Câu hỏi', 'right': 'か (ka)'},
          {'left': 'Ai (Lịch sự)', 'right': 'どなた'},
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        'example_jp': '初めまして、マイクです。',
        'example_rmj': 'Hajimemashite, Maiku desu.',
        'example_vn': 'Rất hân hạnh, tôi là Mike.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'どうぞよろしく',
        ...
        'example_jp': 'どうぞよろしくお願いします。',
        'example_rmj': 'Douzo yoroshiku onegaishimasu.',
        'example_vn': 'Rất mong được sự giúp đỡ của bạn.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '〜から来ました',
        ...
        'options': ['rất vui được gặp', 'tôi đến từ ~', 'tạm biệt', 'xin lỗi'],
        'answer': 'tôi đến từ ~',
      },
      {
        'type': LessonType.vocabQuiz,
      ...
      {
        'type': LessonType.listening,
        'options': ['はじめまして', 'おはよう', 'こんにちは', 'さようなら'],
        'answer': 'はじめまして',
      },
      {
        'type': LessonType.listening,
        'options': ['アメリカからきました', 'ベトナムからきました', 'にほんからきました', 'インドからきました'],
        'answer': 'ベトナムからきました',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Cách hỏi tuổi LỊCH SỰ nhất là?',
        'options': [
        ...
        'answer': 'おいくつですか (o-ikutsu desu ka)',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb1OnTapData() {
    return [
      {
        'type': LessonType.listening,
        'options': ['わたし', 'あなた', 'あのひと', 'だれ'],
        'answer': 'あのひと',
      },
      {
        'type': LessonType.listening,
        'options': ['いしゃ', 'かいしゃいん', 'エンジニア', 'ぎんこういん'],
        'answer': 'かいしゃいん',
      },
      {
        'type': LessonType.quiz,
        'question': 'Từ nào nghĩa là "Bác sĩ"?',
        'options': ['いしゃ', 'せんせい', 'がくせい', 'かいしゃいん'],
        'answer': 'いしゃ',
      },
      {
        'type': LessonType.quiz,
        'question': 'Điền trợ từ: わたし ( ... ) がくせいです。',
        'options': ['は (wa)', 'が (ga)', 'の (no)', 'も (mo)'],
        'answer': 'は (wa)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'hiragana': 'だいがく',
        'romaji': 'daigaku',
        'options': ['đại học', 'bệnh viện', 'công ty', 'trường cấp 3'],
        'answer': 'đại học',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'びょういん',
        'romaji': 'byouin',
        'options': ['bệnh viện', 'ngân hàng', 'công ty', 'siêu thị'],
        'answer': 'bệnh viện',
      },
      {
        'type': LessonType.listening,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Cách hỏi "Ai vậy?" LỊCH SỰ?',
        'options': ['だれですか', 'どなたですか', 'なんさいですか', 'おいくつですか'],
        'answer': 'どなたですか',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getCb2LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': 'それは辞書ですか。',
        'example_rmj': 'Sore wa jisho desu ka.',
        'example_vn': 'Cái đó có phải là từ điển không?',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'あれ',
        ...
        'example_jp': 'あれは私の車です。',
        'example_rmj': 'Are wa watashi no kuruma desu.',
        'example_vn': 'Cái kia là xe hơi của tôi.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'これ',
      ...
      },
      {
        ...
        'example_jp': 'これは日本語の本です。',
        'example_rmj': 'Kore wa nihongo no hon desu.',
        'example_vn': 'Đây là sách tiếng Nhật.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '辞書',
        ...
        'example_jp': 'これは英語の辞書です。',
        'example_rmj': 'Kore wa eigo no jisho desu.',
        'example_vn': 'Đây là từ điển tiếng Anh.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '雑誌',
        ...
        'example_jp': 'それはカメラの雑誌です。',
        'example_rmj': 'Sore wa kamera no zasshi desu.',
        'example_vn': 'Đó là tạp chí máy ảnh.',
      },
      {
        'type': LessonType.listening,
        'options': ['これ', 'それ', 'あれ', 'どれ'],
      ...
      },
      {
        ...
        'hiragana': 'じしょ',
        'romaji': 'jisho',
        'options': ['tạp chí', 'từ điển', 'sách', 'báo'],
        'answer': 'từ điển',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'ざっし',
        'romaji': 'zasshi',
        'options': ['tạp chí', 'sổ tay', 'từ điển', 'chìa khóa'],
        'answer': 'tạp chí',
      },
      {
        'type': LessonType.matching,
    ...
    return [
      {
        ...
        'hiragana': 'かばん',
        'romaji': 'kaban',
        'meaning': 'Cặp xách, túi xách',
        'example_img': 'assets/images/example_kaban.png',
        'example_jp': 'これは私の鞄です。',
        'example_rmj': 'Kore wa watashi no kaban desu.',
        'example_vn': 'Đây là cái cặp của tôi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '傘',
        ...
        'example_jp': 'あれは誰の傘ですか。',
        'example_rmj': 'Are wa dare no kasa desu ka.',
        'example_vn': 'Kia là cây dù của ai vậy?',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '鍵',
        ...
        'example_jp': 'それは車の鍵です。',
        'example_rmj': 'Sore wa kuruma no kagi desu.',
        'example_vn': 'Đó là chìa khóa xe hơi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '時計',
        ...
        'example_jp': 'これは時計です。',
        'example_rmj': 'Kore wa tokei desu.',
        'example_vn': 'Đây là cái đồng hồ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '鞄',
        'hiragana': 'かばん',
        'romaji': 'kaban',
        'options': ['đồng hồ', 'chìa khóa', 'cặp xách', 'cây dù'],
        'answer': 'cặp xách',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'とけい',
        'romaji': 'tokei',
        'options': ['đồng hồ', 'chìa khóa', 'máy ảnh', 'sổ tay'],
        'answer': 'đồng hồ',
      },
      {
        'type': LessonType.listening,
        'options': ['かぎ', 'かばん', 'かさ', 'とけい'],
        'answer': 'かぎ',
      },
      {
        'type': LessonType.quiz,
        'question': 'Từ nào được viết bằng Katakana?',
        'options': ['かばん (kaban)', 'カメラ (kamera)', 'とけい (tokei)', 'かさ (kasa)'],
        'answer': 'カメラ (kamera)',
      },
      {
        'type': LessonType.matching,
  ...
  List<Map<String, dynamic>> _getCb2LuyenTap2Data() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Câu hỏi "Cái này là cái gì?" nói thế nào?',
        'options': ['これはだれですか', 'これはなんですか', 'それはなんですか', 'あれはなんですか'],
        'answer': 'これはなんですか',
      },
      {
        'type': LessonType.quiz,
        'question': 'Điền từ: ( ... ) は時計です。 (Vật ở xa cả 2 người)',
        'options': ['これ', 'それ', 'あれ', 'どれ'],
        'answer': 'あれ',
      },
      {
        'type': LessonType.listening,
        'options': ['これはかばんです', 'それはかばんです', 'あれはかばんです', 'これはかばんですか'],
        'answer': 'それはかばんです',
      },
      {
        'type': LessonType.listening,
        'options': ['これはなんですか', 'それはなんですか', 'あれはなんですか', 'だれですか'],
        'answer': 'これはなんですか',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'pairs': [
          ...
          {'left': 'Cái đó là...', 'right': 'それは...'},
          {'left': 'Cái kia là...', 'right': 'あれは...'},
          {'left': 'Cái gì?', 'right': 'なんですか'},
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        'hiragana': 'この',
        'romaji': 'kono',
        'meaning': '... này (Kèm theo Danh từ)',
        'example_img': 'assets/images/example_kono.png',
        'example_jp': 'この本は私のです。',
        'example_rmj': 'Kono hon wa watashi no desu.',
        'example_vn': 'Quyển sách này là của tôi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '誰の',
        ...
        'example_jp': 'それは誰の鞄ですか。',
        'example_rmj': 'Sore wa dare no kaban desu ka.',
        'example_vn': 'Đó là cặp xách của ai vậy?',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': 'この本は私のです',
      ...
      },
      {
        ...
        'answer': 'この本は... (Kono hon wa...)',
      },
      {
        'type': LessonType.listening,
        'options': ['だれ', 'どなた', 'だれの', 'なん'],
        'answer': 'だれの',
      },
      {
        'type': LessonType.quiz,
        'question':
            'Dịch sang tiếng Nhật: "Quyển tạp chí đó là của anh Yamada."',
        'options': [
          'その雑誌は山田さんのです',
          'それは雑誌の山田さんです',
          'あの雑誌は山田さんのです',
      ...
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Sách này', 'right': 'このほん'},
          {'left': 'Sách đó', 'right': 'そのほん'},
          {'left': 'Sách kia', 'right': 'あのほん'},
          {'left': 'Của tôi', 'right': 'わたしの'},
          {'left': 'Của ai', 'right': 'だれの'},
        ],
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'だれの',
        'romaji': 'dare no',
        'options': ['cái gì', 'của ai', 'ai', 'ở đâu'],
        'answer': 'của ai',
      },
    ];
  }
    ...
    return [
      {
        ...
        'example_jp': 'いいえ、違います。',
        'example_rmj': 'Iie, chigaimasu.',
        'example_vn': 'Không, nhầm rồi (không phải vậy).',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'そうですか',
        'hiragana': 'そうですか',
        'romaji': 'sou desu ka',
        'meaning': 'Thế à / Vậy à (Hiểu ra vấn đề)',
        'example_img': 'assets/images/example_soudesuka.png',
        'example_jp': 'あ、そうですか。',
        'example_rmj': 'A, sou desu ka.',
        'example_vn': 'À, ra là vậy.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'どうぞ',
        ...
        'example_jp': 'これ、どうぞ。',
        'example_rmj': 'Kore, douzo.',
        'example_vn': 'Cái này, xin mời bạn.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '違います',
        'hiragana': 'ちがいます',
        'romaji': 'chigaimasu',
        'options': ['đúng rồi', 'xin mời', 'sai rồi / không phải', 'vậy à'],
        'answer': 'sai rồi / không phải',
      },
      {
        'type': LessonType.listening,
        'options': ['そうですか', 'ちがいます', 'どうぞ', 'ありがとう'],
        'answer': 'そうですか',
      },
      {
        'type': LessonType.listening,
        'options': ['いいえ、ちがいます', 'はい、そうです', 'これ、どうぞ', 'どうも'],
        'answer': 'いいえ、ちがいます',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Khi đưa quà cho ai đó, bạn sẽ nói gì?',
        'options': ['ありがとう', 'どうぞ', 'ちがいます', 'そうですか'],
        'answer': 'どうぞ',
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Vâng, đúng vậy', 'right': 'はい、そうです'},
          {'left': 'Không, sai rồi', 'right': 'いいえ、ちがいます'},
          {'left': 'Thế à', 'right': 'そうですか'},
          {'left': 'Xin mời', 'right': 'どうぞ'},
        ],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb2LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '書',
        'kanji_target': '書',
        'meaning': 'Thư (Viết, sách)',
        'rmj': 'sho / ka(ku)',
      },
      {
        'type': LessonType.quiz,
        'question': 'Kanji "何" có nghĩa là gì?',
        'options': ['Ai', 'Cái gì', 'Ở đâu', 'Khi nào'],
        'answer': 'Cái gì',
      },
      {
        'type': LessonType.quiz,
        'question': 'Kanji "車" đọc là gì?',
        'options': ['hon', 'hito', 'kuruma', 'nani'],
        'answer': 'kuruma',
      },
      {
        'type': LessonType.matching,
  ...
  List<Map<String, dynamic>> _getCb2OnTapData() {
    return [
      ...
      {
        'type': LessonType.listening,
        'options': ['かばん', 'かぎ', 'とけい', 'かさ'],
        'answer': 'かさ',
      },
      {
        'type': LessonType.quiz,
        'question': 'Dịch: "Cái này là máy ảnh."',
        'options': ['それはカメラです', 'これはカメラです', 'あれはカメラです', 'このカメラはわたしのです'],
        'answer': 'これはカメラです',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'hiragana': 'じしょ',
        'romaji': 'jisho',
        'options': ['tạp chí', 'sách', 'từ điển', 'chìa khóa'],
        'answer': 'từ điển',
      },
      {
        'type': LessonType.kanjiDraw,
      ...
      {
        'type': LessonType.listening,
        'options': ['ちがいます', 'そうですか', 'どうぞ', 'ありがとう'],
        'answer': 'ちがいます',
      },
      {
        'type': LessonType.quiz,
        'question': 'Từ nào sai ngữ pháp?',
        'options': ['この本', 'その傘', 'あの時計', 'これ鍵'],
        'answer': 'これ鍵',
      }, // Cố tình hỏi câu tư duy
      {
        'type': LessonType.matching,
        'pairs': [
      ...
      },
      {
        ...
        'hiragana': 'くるま',
        'romaji': 'kuruma',
        'options': ['xe đạp', 'xe hơi', 'máy bay', 'tàu hỏa'],
        'answer': 'xe hơi',
      },
    ...
    return [
      {
        ...
        'example_jp': 'ここは教室です。',
        'example_rmj': 'Koko wa kyoushitsu desu.',
        'example_vn': 'Chỗ này là phòng học.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'そこ',
        ...
        'example_jp': 'そこはトイレですか。',
        'example_rmj': 'Soko wa toire desu ka.',
        'example_vn': 'Chỗ đó có phải là nhà vệ sinh không?',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'あそこ',
        ...
        'example_jp': '事務所はあそこです。',
        'example_rmj': 'Jimusho wa asoko desu.',
        'example_vn': 'Văn phòng ở đằng kia.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'どこ',
        'hiragana': 'どこ',
        'romaji': 'doko',
        'options': ['ở đâu', 'chỗ này', 'chỗ kia', 'cái gì'],
        'answer': 'ở đâu',
      },
      {
        'type': LessonType.flashCard,
        ...
        'example_jp': '教室はどこですか。',
        'example_rmj': 'Kyoushitsu wa doko desu ka.',
        'example_vn': 'Phòng học ở đâu vậy?',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '食堂',
        ...
        'example_jp': 'ここは食堂です。',
        'example_rmj': 'Koko wa shokudou desu.',
        'example_vn': 'Đây là nhà ăn.',
      },
      {
        'type': LessonType.listening,
      ...
      },
      {
        ...
        'hiragana': 'じむしょ',
        'romaji': 'jimusho',
        'options': ['phòng học', 'nhà ăn', 'văn phòng', 'bệnh viện'],
        'answer': 'văn phòng',
      },
      {
        'type': LessonType.vocabSummary,
    ...
    return [
      {
        ...
        'example_jp': '山田さんの部屋はあそこです。',
        'example_rmj': 'Yamada-san no heya wa asoko desu.',
        'example_vn': 'Phòng của anh Yamada ở đằng kia.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '受付',
        ...
        'example_jp': '受付はここです。',
        'example_rmj': 'Uketsuke wa koko desu.',
        'example_vn': 'Quầy lễ tân ở đây.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'トイレ',
        'hiragana': 'といれ',
        'romaji': 'toire',
        'options': ['căn phòng', 'thang máy', 'nhà vệ sinh', 'hành lang'],
        'answer': 'nhà vệ sinh',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'えれべーたー',
        'romaji': 'erebe-ta-',
        'options': ['thang cuốn', 'thang máy', 'cầu thang', 'hành lang'],
        'answer': 'thang máy',
      },
      {
        'type': LessonType.quiz,
        'question': 'Từ nào nghĩa là "Thang cuốn"?',
        'options': ['エレベーター', 'エスカレーター', 'コンピューター', 'カメラ'],
        'answer': 'エスカレーター',
      },
      {
        'type': LessonType.matching,
    ...
    return [
      {
        ...
        'example_img': 'assets/images/example_koko.png',
        'example_jp': 'トイレはあそこです。',
        'example_rmj': 'Toire wa asoko desu.',
      ...
      },
      {
        ...
        'example_img': 'assets/images/example_soko.png',
        'example_jp': '食堂はどこですか。',
        'example_rmj': 'Shokudou wa doko desu ka.',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Dịch: "Điện thoại ở đằng kia."',
        'options': ['電話はあそこです', '電話はここです', 'あそこは電話です', '電話はどこですか'],
        'answer': '電話はあそこです',
      },
      {
        'type': LessonType.listening,
        'options': ['ここはきょうしつです', 'そこはきょうしつです', 'あそこはきょうしつです', 'きょうしつはどこですか'],
        'answer': 'きょうしつはどこですか',
      },
    ];
  }
    ...
    return [
      {
        ...
        'example_jp': 'それは日本の靴です。',
        'example_rmj': 'Sore wa nihon no kutsu desu.',
        'example_vn': 'Đó là giầy của Nhật.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'いくら',
        ...
        'example_jp': 'この靴はいくらですか。',
        'example_rmj': 'Kono kutsu wa ikura desu ka.',
        'example_vn': 'Đôi giầy này bao nhiêu tiền?',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': 'この時計はいくらですか',
      ...
      },
      {
        ...
        'hiragana': 'まん',
        'romaji': 'man',
        'options': ['mười', 'trăm', 'ngàn', 'mười ngàn (vạn)'],
        'answer': 'mười ngàn (vạn)',
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Giầy', 'right': '靴'},
          {'left': 'Bao nhiêu tiền', 'right': 'いくら'},
          {'left': 'Nước (quốc gia)', 'right': '国'},
          {'left': 'Công ty', 'right': '会社'},
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        'hiragana': 'すみません',
        'romaji': 'sumimasen',
        'meaning': 'Xin lỗi (Dùng khi gọi nhân viên)',
        'example_img': 'assets/images/example_sumimasen.png',
        'example_jp': 'すみません、時計を見せてください。',
        'example_rmj': 'Sumimasen, tokei o misete kudasai.',
        'example_vn': 'Xin lỗi, cho tôi xem cái đồng hồ.',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': 'じゃ、これをください',
      ...
      {
        'type': LessonType.listening,
        'options': ['いくらですか', 'どこですか', 'だれですか', 'なんですか'],
        'answer': 'いくらですか',
      },
      {
        'type': LessonType.quiz,
        'question': 'Câu nói khi quyết định mua hàng là?',
        'options': ['これをください', 'これを見せてください', 'いくらですか', 'そうですか'],
        'answer': 'これをください',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb3OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Phòng học ở đâu? (Dịch)',
        'options': ['教室はどこですか', '教室はここですか', '教室はいくらですか', 'ここは教室ですか'],
        'answer': '教室はどこですか',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'hiragana': 'くつ',
        'romaji': 'kutsu',
        'options': ['quần áo', 'giầy', 'cà vạt', 'đồng hồ'],
        'answer': 'giầy',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getCb4LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'hiragana': 'じ',
        'romaji': 'ji',
        'meaning': 'Giờ (dùng kèm số)',
        'example_img': 'assets/images/example_ji.png',
        'example_jp': '今は９時です。',
        'example_rmj': 'Ima wa kuji desu.',
        'example_vn': 'Bây giờ là 9 giờ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '分',
      ...
      },
      {
        ...
        'hiragana': 'はん',
        'romaji': 'han',
        'options': ['nửa / rưỡi', 'toàn bộ', 'một phần', 'chưa tới'],
        'answer': 'nửa / rưỡi',
      },
      {
        'type': LessonType.listening,
        'options': ['いま', 'なんじ', 'なんぷん', 'はん'],
        'answer': 'なんじ',
      },
      {
        'type': LessonType.sentenceBuilder,
  ...
  List<Map<String, dynamic>> _getCb4LuyenTap1Data() {
    return [
      ...
      },
      {
        ...
        'hiragana': 'にちようび',
        'romaji': 'nichiyoubi',
        'options': ['Thứ sáu', 'Thứ bảy', 'Chủ nhật', 'Hôm qua'],
        'answer': 'Chủ nhật',
      },
      {
        'type': LessonType.listening,
        'options': ['げつようび', 'すいようび', 'きんようび', 'にちようび'],
        'answer': 'きんようび',
      },
      {
        'type': LessonType.quiz,
        'question': 'Hôm nay là thứ mấy? (Tiếng Nhật)',
        'options': [
          'きょうはなんようびですか',
          'きょうはなんじですか',
          'きょうはなんにちですか',
    ...
    return [
      {
        ...
        'example_rmj': 'Maiasa rokuji ni okimasu.',
      ...
      },
      {
        ...
        'example_jp': '11時に寝ます。',
        'example_rmj': 'Juu-ichi ji ni nemasu.',
      ...
      },
      {
        ...
        'meaning': 'Thức dậy',
        'example_img': 'assets/images/example_okimasu.png',
        'example_jp': '私は毎朝６時に起きます。',
        'example_rmj': 'Watashi wa maiasa rokuji ni okimasu.',
        'example_vn': 'Tôi thức dậy lúc 6 giờ mỗi sáng.',
      },
      {
        'type': LessonType.flashCard,
        ...
        'meaning': 'Ngủ',
        'example_img': 'assets/images/example_nemasu.png',
        'example_jp': '昨日の夜、１１時に寝ました。',
        'example_rmj': 'Kinou no yoru, juu-ichi ji ni nemashita.',
        'example_vn': 'Đêm qua tôi đã ngủ lúc 11 giờ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '働きます',
        'hiragana': 'はたらきます',
        'romaji': 'hatarakimasu',
        'options': ['nghỉ ngơi', 'làm việc', 'học tập', 'kết thúc'],
        'answer': 'làm việc',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'やすみます',
        'romaji': 'yasumimasu',
        'options': ['thức dậy', 'làm việc', 'học tập', 'nghỉ ngơi'],
        'answer': 'nghỉ ngơi',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'options': ['làm việc', 'nghỉ ngơi', 'học tập', 'thức dậy'],
        'answer': 'học tập',
      },
      {
        'type': LessonType.sentenceBuilder,
  ...
  List<Map<String, dynamic>> _getCb4LuyenTap3Data() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ đi với thời gian cụ thể (lúc mấy giờ) là gì?',
        'options': ['に (ni)', 'で (de)', 'を (o)', 'へ (he)'],
        'answer': 'に (ni)',
      },
      {
        'type': LessonType.quiz,
        'question': 'Thì Quá khứ của です (desu) là gì?',
        'options': [
          'でした (deshita)',
          'じゃありません (ja arimasen)',
          'ます (masu)',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Động từ phủ định ở thì hiện tại kết thúc bằng gì?',
        'options': [
          '～ます (~masu)',
          '～ました (~mashita)',
          '～ません (~masen)',
    ...
    return [
      {
        ...
        'meaning': 'Vất vả cho bạn quá / Bạn mệt nhỉ',
        'example_img': 'assets/images/example_taihen.png',
        'example_jp': '毎日１０時まで働きます。大変ですね。',
        'example_rmj': 'Mainichi juuji made hatarakimasu. Taihen desu ne.',
        'example_vn': 'Ngày nào tôi cũng làm đến 10 giờ. Vất vả quá nhỉ.',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': 'そちらは何時までですか',
      ...
      {
        'type': LessonType.listening,
        'options': ['たいへんですね', 'ありがとうございます', 'すみません', 'どうぞ'],
        'answer': 'たいへんですね',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb4OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Bây giờ là mấy giờ? (Dịch)',
        'options': ['今は何時ですか', '今は何分ですか', '今日は何曜日ですか', '明日は何日ですか'],
        'answer': '今は何時ですか',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'hiragana': 'おきます',
        'romaji': 'okimasu',
        'options': ['ngủ', 'thức dậy', 'làm việc', 'nghỉ ngơi'],
        'answer': 'thức dậy',
      },
      {
        'type': LessonType.kanjiDraw,
    ...
    return [
      {
        ...
        'example_jp': '私は京都へ行きます。',
        'example_rmj': 'Watashi wa Kyouto e ikimasu.',
        'example_vn': 'Tôi đi Kyoto.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '来ます',
        ...
        'example_jp': '昨日、日本へ来ました。',
        'example_rmj': 'Kinou, Nihon e kimashita.',
        'example_vn': 'Tôi đã đến Nhật Bản hôm qua.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '帰ります',
      ...
      },
      {
        ...
        'hiragana': 'きます',
        'romaji': 'kimasu',
        'options': ['đến', 'thức dậy', 'làm việc', 'về'],
        'answer': 'đến',
      },
      {
        'type': LessonType.matching,
    ...
    return [
      {
        ...
        'example_jp': '電車で会社へ行きます。',
        'example_rmj': 'Densha de kaisha e ikimasu.',
        'example_vn': 'Tôi đi đến công ty bằng tàu điện.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '自転車',
        ...
        'example_jp': '自転車でうちへ帰ります。',
        'example_rmj': 'Jitensha de uchi e kaerimasu.',
        'example_vn': 'Tôi về nhà bằng xe đạp.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '飛行機',
        'hiragana': 'ひこうき',
        'romaji': 'hikouki',
        'options': ['xe buýt', 'xe đạp', 'máy bay', 'tàu thủy'],
        'answer': 'máy bay',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'あるいて',
        'romaji': 'aruite',
        'options': ['đi bộ', 'chạy', 'đi xe', 'bơi'],
        'answer': 'đi bộ',
      },
      {
        'type': LessonType.listening,
        'options': ['でんしゃ', 'ちかてつ', 'じてんしゃ', 'ひこうき'],
        'answer': 'ちかてつ',
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Xe đạp', 'right': '自転車'},
          {'left': 'Tàu điện', 'right': '電車'},
          {'left': 'Tàu điện ngầm', 'right': '地下鉄'},
          {'left': 'Đi bộ', 'right': '歩いて'},
        ],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb5LuyenTap2Data() {
    return [
      ...
      },
      {
        ...
        'example_img': 'assets/images/example_kaerimasu.png',
        'example_jp': '今日はどこへも行きません。',
        'example_rmj': 'Kyou wa doko e mo ikimasen.',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ chỉ hướng di chuyển (Đi đến...) viết là gì?',
        'options': ['へ (he)', 'に (ni)', 'で (de)', 'を (o)'],
        'answer': 'へ (he)',
      },
      {
        'type': LessonType.quiz,
        'question': 'Phủ định hoàn toàn: "Tôi không đi đâu cả" nói thế nào?',
        'options': ['どこへも行きません', 'どこへ行きます', 'どこも行きません', 'だれも行きません'],
        'answer': 'どこへも行きません',
      },
      {
        'type': LessonType.listening,
        'options': ['うちへかえります', 'がっこうへいきます', 'スーパーへいきます', 'どこへもいきません'],
        'answer': 'どこへもいきません',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb5LuyenTap3Data() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Hỏi "Đi với ai?" dùng từ gì?',
        'options': [
          'だれと (dare to)',
          'なんで (nan de)',
          'だれで (dare de)',
    ...
    return [
      {
        ...
        'hiragana': 'いつ',
        'romaji': 'itsu',
        'options': ['khi nào', 'ở đâu', 'ai', 'cái gì'],
        'answer': 'khi nào',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'たんじょうび',
        'romaji': 'tanjoubi',
        'options': ['ngày mai', 'sinh nhật', 'hôm nay', 'năm sau'],
        'answer': 'sinh nhật',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.listening,
        'options': ['いつですか', 'どこですか', 'だれですか', 'なんですか'],
        'answer': 'いつですか',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb5OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ chỉ phương tiện di chuyển (Bằng...) là?',
        'options': ['で (de)', 'に (ni)', 'と (to)', 'を (o)'],
        'answer': 'で (de)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'hiragana': 'ひこうき',
        'romaji': 'hikouki',
        'options': ['máy bay', 'tàu thủy', 'tàu điện', 'xe đạp'],
        'answer': 'máy bay',
      },
      {
        'type': LessonType.kanjiDraw,
    ...
    return [
      {
        ...
        'example_jp': 'パンを食べます。',
        'example_rmj': 'Pan o tabemasu.',
        'example_vn': 'Tôi ăn bánh mì.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '飲みます',
      ...
      },
      {
        ...
        'example_jp': 'テレビを見ます。',
        'example_rmj': 'Terebi o mimasu.',
        'example_vn': 'Tôi xem ti vi.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '買います',
  ...
  List<Map<String, dynamic>> _getCb6LuyenTap1Data() {
    return [
      ...
      },
      {
        ...
        'hiragana': 'たまご',
        'romaji': 'tamago',
        'options': ['trái cây', 'sữa', 'trứng', 'bánh mì'],
        'answer': 'trứng',
      },
      {
        'type': LessonType.listening,
        'options': ['ごはん', 'パン', 'にく', 'さかな'],
        'answer': 'ごはん',
      },
      {
        'type': LessonType.matching,
  ...
  List<Map<String, dynamic>> _getCb6LuyenTap2Data() {
    return [
      ...
      },
      {
        ...
        'example_img': 'assets/images/example_nomimasu.png',
        'example_jp': '何を飲みますか。',
        'example_rmj': 'Nani o nomimasu ka.',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ nối TÂN NGỮ và ĐỘNG TỪ (Ăn bánh, Uống nước) là gì?',
        'options': ['を (o)', 'で (de)', 'に (ni)', 'が (ga)'],
        'answer': 'を (o)',
      },
      {
        'type': LessonType.quiz,
        'question': 'Dịch: "Tôi không ăn gì cả."',
        'options': ['何も食べません', '何も食べます', 'どこも行きません', '何をたべません'],
        'answer': '何も食べません',
      },
      {
        'type': LessonType.listening,
        'options': ['なにをしますか', 'なにをたべますか', 'なにをのみますか', 'なにもしません'],
        'answer': 'なにをしますか',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb6LuyenTap3Data() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ chỉ NƠI XẢY RA HÀNH ĐỘNG (Làm gì TẠI đâu) là?',
        'options': ['で (de)', 'に (ni)', 'へ (he)', 'を (o)'],
        'answer': 'で (de)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Cấu trúc dùng để RỦ RÊ, MỜI MỌC ai đó?',
        'options': [
          '～ませんか (~masen ka)',
          '～ますか (~masu ka)',
          '～ましたか (~mashita ka)',
        ...
        'answer': '～ませんか (~masen ka)',
      },
      {
        'type': LessonType.listening,
        'options': ['いっしょにいきませんか', 'いきましょう', 'ちょっと...', 'いいですね'],
        'answer': 'いっしょにいきませんか',
      },
    ];
  }
    ...
    return [
      {
        ...
        'hiragana': 'いいですね',
        'romaji': 'Ii desu ne',
        'meaning': 'Hay quá nhỉ / Được đấy',
        'example_img': 'assets/images/example_iidesune.png',
        'example_jp': '一緒にビールを飲みませんか。いいですね。',
        'example_rmj': 'Issho ni bi-ru o nomimasen ka. Ii desu ne.',
        'example_vn': 'Cùng uống bia nhé. Được đấy nhỉ.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'ちょっと...',
        'hiragana': 'ちょっと',
        'romaji': 'chotto...',
        'meaning': 'Có chút... (Cách từ chối khéo)',
        'example_img': 'assets/images/example_chotto.png',
        'example_jp': '今日はちょっと...',
        'example_rmj': 'Kyou wa chotto...',
        'example_vn': 'Hôm nay thì có chút (không tiện)...',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': 'ちょっと休みましょう',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Đồng ý lời rủ rê một cách hào hứng, ta dùng?',
        'options': ['～ましょう (~mashou)', '～ません (~masen)', 'ちょっと...', 'ちがいます'],
        'answer': '～ましょう (~mashou)',
      },
    ];
  }
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Trợ từ đứng sau Nơi chốn để chỉ địa điểm xảy ra hành động?',
        'options': ['で (de)', 'に (ni)', 'へ (he)', 'を (o)'],
        'answer': 'で (de)',
      },
      {
    ...
    return [
      {
        ...
        'example_jp': 'はさみで紙を切ります。',
        'example_rmj': 'Hasami de kami o kirimasu.',
      ...
      },
      {
        ...
        'example_jp': '木村さんに花をあげます。',
        'example_rmj': 'Kimura-san ni hana o agemasu.',
        'example_vn': 'Tôi tặng hoa cho chị Kimura.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'もらいます',
        ...
        'example_jp': '父に時計をもらいました。',
        'example_rmj': 'Chichi ni tokei o moraimashita.',
        'example_vn': 'Tôi đã nhận đồng hồ từ bố.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '送ります',
  ...
  List<Map<String, dynamic>> _getCb7LuyenTap1Data() {
    return [
      ...
      },
      {
        ...
        'hiragana': 'ぱそこん',
        'romaji': 'pasokon',
        'options': ['ti vi', 'điện thoại', 'máy tính cá nhân', 'máy ảnh'],
        'answer': 'máy tính cá nhân',
      },
      {
        'type': LessonType.listening,
        'options': ['て', 'はし', 'スプーン', 'ナイフ'],
        'answer': 'はし',
      },
      {
        'type': LessonType.matching,
  ...
  List<Map<String, dynamic>> _getCb7LuyenTap2Data() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ chỉ CÔNG CỤ / PHƯƠNG TIỆN (Bằng cái gì) là?',
        'options': ['で (de)', 'に (ni)', 'を (o)', 'へ (he)'],
        'answer': 'で (de)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.listening,
        'options': ['にほんごでかきます', 'えいごでかきます', 'はしでたべます', 'てでたべます'],
        'answer': 'にほんごでかきます',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb7LuyenTap3Data() {
    return [
      ...
      },
      {
        'type': LessonType.quiz,
        'question':
            'Trợ từ đi sau đối tượng NHẬN HÀNH ĐỘNG (Cho ai, Mượn từ ai) là?',
        'options': ['に (ni)', 'で (de)', 'を (o)', 'は (wa)'],
        'answer': 'に (ni)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Dịch: "Tôi gọi điện thoại cho mẹ."',
        'options': ['母に電話をかけます', '母で電話をかけます', '母と電話をかけます', '母は電話をかけます'],
        'answer': '母に電話をかけます',
      },
    ];
  }
    ...
    return [
      {
        ...
        'example_jp': 'もう昼ごはんを食べましたか。',
        'example_rmj': 'Mou hirugohan o tabemashita ka.',
        'example_vn': 'Bạn đã ăn trưa rồi à?',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'まだです',
        ...
        'example_jp': 'いいえ、まだです。',
        'example_rmj': 'Iie, mada desu.',
        'example_vn': 'Không, tôi vẫn chưa (ăn).',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': 'もうレポートを送りました',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Phủ định của "Đã làm rồi" trong hội thoại là gì?',
        'options': ['まだです', 'ちがいます', 'いいえ、しません', 'いいえ、しませんでした'],
        'answer': 'まだです',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb7OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ đi với CÔNG CỤ (Bằng kéo, bằng tiếng Nhật)?',
        'options': ['で (de)', 'に (ni)', 'を (o)', 'と (to)'],
        'answer': 'で (de)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      },
      {
        ...
        'kanji_word': '手紙',
        'kanji_target': '紙',
        'meaning': 'Chỉ (Giấy - trong Bức thư)',
        'rmj': 'kami / gami',
      },
      {
        'type': LessonType.listening,
        'options': ['もうたべました', 'まだです', 'もうおわりました', 'これからたべます'],
        'answer': 'まだです',
      },
      {
        'type': LessonType.vocabSummary,
    ...
    return [
      {
        ...
        'example_jp': 'ミラーさんはハンサムです。',
        'example_rmj': 'Mira-san wa hansamu desu.',
        'example_vn': 'Anh Miller đẹp trai.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'きれい（な）',
        ...
        'example_jp': 'きれいな花ですね。',
        'example_rmj': 'Kireina hana desu ne.',
        'example_vn': 'Bông hoa đẹp quá nhỉ.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '静か（な）',
        ...
        'example_jp': 'ここは静かです。',
        'example_rmj': 'Koko wa shizuka desu.',
        'example_vn': 'Chỗ này yên tĩnh.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '賑やか',
        'hiragana': 'にぎやか',
        'romaji': 'nigiyaka',
        'options': ['yên tĩnh', 'náo nhiệt', 'nổi tiếng', 'đẹp'],
        'answer': 'náo nhiệt',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'ゆうめい',
        'romaji': 'yuumei',
        'options': ['đẹp trai', 'náo nhiệt', 'nổi tiếng', 'sạch sẽ'],
        'answer': 'nổi tiếng',
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Đẹp, sạch', 'right': 'きれい'},
          {'left': 'Yên tĩnh', 'right': '静か'},
          {'left': 'Nổi tiếng', 'right': '有名'},
          {'left': 'Náo nhiệt', 'right': '賑やか'},
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        'example_jp': '大きい鞄を買いました。',
        'example_rmj': 'Ookii kaban o kaimashita.',
        'example_vn': 'Tôi đã mua một cái cặp to.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '小さい',
        ...
        'example_jp': 'その車は小さいです。',
        'example_rmj': 'Sono kuruma wa chiisai desu.',
        'example_vn': 'Chiếc xe đó thì nhỏ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '新しい',
    ...
    return [
      {
        ...
        'example_rmj': 'Kono tokei wa takai desu.',
      ...
      },
      {
        ...
        'example_img': 'assets/images/example_shizuka.png',
        'example_jp': 'ここは静かな町です。',
        'example_rmj': 'Koko wa shizuka na machi desu.',
      ...
      },
      {
        'type': LessonType.quiz,
        'question':
            'Cách phủ định tính từ đuôi "i" (ví dụ: takai -> không đắt) là?',
        'options': [
          'takai ja arimasen',
          'takakunai desu',
          'takakatta desu',
        ...
        'answer': 'takakunai desu',
      },
      {
        'type': LessonType.quiz,
        'question': 'Phủ định của いい (tốt) là gì?',
        'options': ['いくないです', 'よくないです', 'いいじゃありません', 'いかありません'],
        'answer': 'よくないです',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb8LuyenTap3Data() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Từ chỉ mức độ "Rất..." trong tiếng Nhật là?',
        'options': ['とても (totemo)', 'あまり (amari)', 'そして (soshite)', 'が (ga)'],
        'answer': 'とても (totemo)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Từ nối hai câu mang ý nghĩa trái ngược "Nhưng..." là?',
        'options': ['そして (soshite)', 'が (ga)', 'とても (totemo)', 'どんな (donna)'],
        'answer': 'が (ga)',
      },
    ];
  }
    ...
    return [
      {
        ...
        'hiragana': 'どんな',
        'romaji': 'donna',
        'options': ['như thế nào', 'cái gì', 'ở đâu', 'khi nào'],
        'answer': 'như thế nào',
      },
      {
        'type': LessonType.sentenceBuilder,
  ...
  List<Map<String, dynamic>> _getCb8OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Tính từ đuôi NA khi bổ nghĩa cho Danh từ thì...',
        'options': ['Bỏ NA', 'Giữ nguyên NA', 'Đổi thành I', 'Thêm NO'],
        'answer': 'Giữ nguyên NA',
      },
      {
        'type': LessonType.sentenceBuilder,
        'jp': '富士山はきれいで、高い山です',
      ...
      {
        'type': LessonType.listening,
        'options': ['とてもいいです', 'あまりよくないです', 'いいです', 'よくないです'],
        'answer': 'あまりよくないです',
      },
      {
        'type': LessonType.vocabSummary,
  ...
  List<Map<String, dynamic>> _getCb9LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '魚が嫌いです。',
        'example_rmj': 'Sakana ga kirai desu.',
        'example_vn': 'Tôi ghét cá.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '上手（な）',
        ...
        'example_jp': '彼女は歌が上手です。',
        'example_rmj': 'Kanojo wa uta ga jouzu desu.',
        'example_vn': 'Cô ấy hát giỏi.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '下手',
      ...
      },
      {
        ...
        'hiragana': 'りょうり',
        'romaji': 'ryouri',
        'options': ['thể thao', 'món ăn / nấu ăn', 'âm nhạc', 'bức tranh'],
        'answer': 'món ăn / nấu ăn',
      },
      {
        'type': LessonType.matching,
        'pairs': [
  ...
  List<Map<String, dynamic>> _getCb9LuyenTap1Data() {
    return [
      ...
      },
      {
        ...
        'example_jp': '車があります。',
        'example_rmj': 'Kuruma ga arimasu.',
        'example_vn': 'Tôi có xe hơi.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '時間',
        'hiragana': 'じかん',
        'romaji': 'jikan',
        'options': ['thời gian', 'tiền bạc', 'cuộc hẹn', 'việc bận'],
        'answer': 'thời gian',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'ようじ',
        'romaji': 'youji',
        'options': ['cuộc hẹn', 'việc bận', 'thời gian', 'gia đình'],
        'answer': 'việc bận',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'やくそく',
        'romaji': 'yakusoku',
        'options': ['thời gian', 'việc bận', 'lời hứa, cuộc hẹn', 'công việc'],
        'answer': 'lời hứa, cuộc hẹn',
      },
      {
        'type': LessonType.listening,
        'options': ['わかります', 'あります', 'います', 'ききます'],
        'answer': 'わかります',
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Hiểu', 'right': '分かります'},
          {'left': 'Có', 'right': 'あります'},
          {'left': 'Thời gian', 'right': '時間'},
          {'left': 'Cuộc hẹn', 'right': '約束'},
        ],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb9LuyenTap2Data() {
    return [
      ...
      },
      {
        'type': LessonType.quiz,
        'question':
            'Trợ từ đi trước 好き(Thích), 上手(Giỏi), 分かる(Hiểu), ある(Có) là gì?',
        'options': ['を (o)', 'が (ga)', 'に (ni)', 'へ (he)'],
        'answer': 'が (ga)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.quiz,
        'question': 'Hỏi "Thích loại N nào" dùng cấu trúc?',
        'options': ['どんな N', 'どれ N', 'なんの N', 'どう N'],
        'answer': 'どんな N',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb9LuyenTap3Data() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Từ chỉ mức độ "Hơi hơi, một chút" là?',
        'options': [
          'よく (yoku)',
          'だいたい (daitai)',
          'すこし (sukoshi)',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Từ chỉ mức độ "Hoàn toàn không" (Đi với phủ định) là?',
        'options': [
          'あまり (amari)',
          'ぜんぜん (zenzen)',
          'よく (yoku)',
    ...
    return [
      {
        ...
        'example_jp': '時間がないから、新聞を読みません。',
        'example_rmj': 'Jikan ga nai kara, shinbun o yomimasen.',
        'example_vn': 'Vì không có thời gian, nên tôi không đọc báo.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'どうして',
        'hiragana': 'どうして',
        'romaji': 'doushite',
        'options': ['như thế nào', 'tại sao', 'khi nào', 'ở đâu'],
        'answer': 'tại sao',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.listening,
        'options': ['どうしてですか', 'いつですか', 'だれですか', 'どこですか'],
        'answer': 'どうしてですか',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb9OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ trước "Arimasu" (Có) là?',
        'options': ['を (o)', 'が (ga)', 'に (ni)', 'で (de)'],
        'answer': 'が (ga)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.listening,
        'options': ['よくわかります', 'だいたいわかります', 'すこしわかります', 'ぜんぜんわかりません'],
        'answer': 'ぜんぜんわかりません',
      },
      {
        'type': LessonType.vocabSummary,
    ...
    return [
      {
        ...
        'example_jp': 'あそこに机があります。',
        'example_rmj': 'Asoko ni tsukue ga arimasu.',
        'example_vn': 'Ở đằng kia có cái bàn.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'います',
        ...
        'example_jp': 'あそこに男の人がいます。',
        'example_rmj': 'Asoko ni otoko no hito ga imasu.',
        'example_vn': 'Ở đằng kia có người đàn ông.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'いろいろ（な）',
        'hiragana': 'いろいろ',
        'romaji': 'iroiro',
        'options': ['to lớn', 'màu sắc', 'nhiều loại / đa dạng', 'ít'],
        'answer': 'nhiều loại / đa dạng',
      },
      {
        'type': LessonType.quiz,
        'question': 'Khi nói "Có quyển sách" ta dùng từ nào?',
        'options': [
          'あります (arimasu)',
          'います (imasu)',
          'きます (kimasu)',
      ...
      {
        'type': LessonType.quiz,
        'question': 'Khi nói "Có con chó" ta dùng từ nào?',
        'options': [
          'あります (arimasu)',
          'います (imasu)',
          'きます (kimasu)',
      ...
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Có (Vật)', 'right': 'あります'},
          {'left': 'Có (Người/ĐV)', 'right': 'います'},
          {'left': 'Nhiều loại', 'right': 'いろいろ'},
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        'example_jp': '男の人がいます。',
        'example_rmj': 'Otoko no hito ga imasu.',
        'example_vn': 'Có người đàn ông.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '女の人',
        ...
        'example_jp': '女の人がいます。',
        'example_rmj': 'Onna no hito ga imasu.',
        'example_vn': 'Có người phụ nữ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '男の子',
        'hiragana': 'おとこのこ',
        'romaji': 'otoko no ko',
        'options': ['người đàn ông', 'bé trai', 'người phụ nữ', 'bé gái'],
        'answer': 'bé trai',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'おんなのこ',
        'romaji': 'onna no ko',
        'options': ['người phụ nữ', 'bé gái', 'người đàn ông', 'bé trai'],
        'answer': 'bé gái',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'いぬ',
        'romaji': 'inu',
        'options': ['con mèo', 'con cá', 'con chó', 'con chim'],
        'answer': 'con chó',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'ねこ',
        'romaji': 'neko',
        'options': ['con mèo', 'con chó', 'con chim', 'con chuột'],
        'answer': 'con mèo',
      },
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'Đàn ông', 'right': '男の人'},
          {'left': 'Phụ nữ', 'right': '女の人'},
          {'left': 'Chó', 'right': '犬'},
          {'left': 'Mèo', 'right': '猫'},
        ],
      },
    ...
    return [
      {
        ...
        'example_rmj': 'Tsukue no ue ni hon ga arimasu.',
        'example_vn': 'Ở trên bàn có sách.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '下',
        ...
        'example_jp': '机の下に猫がいます。',
        'example_rmj': 'Tsukue no shita ni neko ga imasu.',
        'example_vn': 'Ở dưới bàn có con mèo.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '前',
  ...
  List<Map<String, dynamic>> _getCb10LuyenTap3Data() {
    return [
      ...
      },
      {
        'type': LessonType.quiz,
        'question':
            'Trợ từ đi sau Địa điểm để chỉ SỰ TỒN TẠI (Ở đâu có cái gì) là?',
        'options': ['に (ni)', 'で (de)', 'へ (he)', 'を (o)'],
        'answer': 'に (ni)',
      },
      {
        'type': LessonType.sentenceBuilder,
    ...
    return [
      {
        ...
        'hiragana': 'となり',
        'romaji': 'tonari',
        'options': ['bên cạnh', 'gần', 'giữa', 'đối diện'],
        'answer': 'bên cạnh',
      },
      {
        'type': LessonType.vocabQuiz,
      ...
      {
        'type': LessonType.listening,
        'options': ['となりにあります', 'ちかくにあります', 'あいだにあります', 'なかにあります'],
        'answer': 'となりにあります',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getCb10OnTapData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Trợ từ dùng khi nói "Có A và B..." là?',
        'options': ['や (ya)', 'と (to)', 'も (mo)', 'が (ga)'],
        'answer': 'や (ya)',
      },
      {
        'type': LessonType.sentenceBuilder,
      ...
      {
        'type': LessonType.listening,
        'options': ['うえにあります', 'したにあります', 'まえにあります', 'うしろにあります'],
        'answer': 'したにあります',
      },
      {
        'type': LessonType.vocabSummary,
        'words': [
          ...
          {
            'kanji': '隣/近く/間',
            'romaji': 'tonari/chikaku/aida',
            'meaning': 'Bên cạnh/Gần/Giữa',
          },
        ],
      },
    ];
  ...
  List<Map<String, dynamic>> _getHangAData() => [
    ...
    {
      'type': LessonType.quiz,
      'question': 'Chữ nào là "i" (Hiragana)?',
      'options': ['あ', 'い', 'ア', 'イ'],
      'answer': 'い',
    },
    {'type': LessonType.speaking, 'jp': 'あ', 'answer': 'あ'},
    {
      'type': LessonType.learn,
      'char': 'う',
      'romaji': 'u',
      'gif': 'assets/gifs/u.gif',
      'isHiragana': true,
    },
    {
      'type': LessonType.learn,
    ...
    },
    {
      ...
      'char': 'エ',
      'romaji': 'e (Katakana)',
      'gif': 'assets/gifs/ek.gif',
      'isHiragana': false,
    },
    {
      'type': LessonType.quiz,
      'question': 'Chữ nào là "E" (Katakana)?',
      'options': ['エ', 'オ', 'え', 'う'],
      'answer': 'エ',
    },
    {
  ...
  List<Map<String, dynamic>> _getHangKaData() {
    return [
      ...
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Ki" (Hiragana)?',
        'options': ['か', 'き', 'く', 'け'],
        'answer': 'き',
      },
      {'type': LessonType.speaking, 'jp': 'か', 'answer': 'か'},
      {
        'type': LessonType.learn,
        'char': 'く',
        'romaji': 'ku',
        'gif': 'assets/gifs/ku.gif',
        'isHiragana': true,
      },
      {
        'type': LessonType.learn,
      ...
      },
      {
        ...
        'char': 'ケ',
        'romaji': 'ke (Katakana)',
        'gif': 'assets/gifs/kek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Ku" (Katakana)?',
        'options': ['ク', 'シ', 'ツ', 'ソ'],
        'answer': 'ク',
      },
      {
      ...
      },
      {
        ...
        'char': 'コ',
        'romaji': 'ko (Katakana)',
        'gif': 'assets/gifs/kok.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Ke" (Hiragana)',
        'options': ['け', 'い', 'は', 'ほ'],
        'answer': 'け',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangSaData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': 'さ', 'answer': 'さ'},
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'さ', 'right': 'サ'},
      ...
      },
      {
        ...
        'char': 'セ',
        'romaji': 'se (Katakana)',
        'gif': 'assets/gifs/sek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Shi" (Katakana)?',
        'options': ['シ', 'ツ', 'ソ', 'ン'],
        'answer': 'シ',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangTaData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': 'た', 'answer': 'た'},
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'た', 'right': 'タ'},
      ...
      },
      {
        ...
        'char': 'テ',
        'romaji': 'te (Katakana)',
        'gif': 'assets/gifs/tek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Tsu" (Hiragana)?',
        'options': ['つ', 'う', 'し', 'て'],
        'answer': 'つ',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangNaData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': 'な', 'answer': 'な'},
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'な', 'right': 'ナ'},
      ...
      },
      {
        ...
        'char': 'ネ',
        'romaji': 'ne (Katakana)',
        'gif': 'assets/gifs/nek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Ni" (Katakana)?',
        'options': ['ニ', 'こ', 'ネ', 'ミ'],
        'answer': 'ニ',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangHaData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': 'は', 'answer': 'は'},
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'は', 'right': 'ハ'},
      ...
      },
      {
        ...
        'char': 'ヘ',
        'romaji': 'he (Katakana)',
        'gif': 'assets/gifs/hek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Fu" (Hiragana)?',
        'options': ['ふ', 'う', 'く', 'む'],
        'answer': 'ふ',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangMaData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': 'ま', 'answer': 'ま'},
      {
        'type': LessonType.matching,
        'pairs': [
          {'left': 'ま', 'right': 'マ'},
      ...
      },
      {
        ...
        'char': 'メ',
        'romaji': 'me (Katakana)',
        'gif': 'assets/gifs/mek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Me" (Hiragana)?',
        'options': ['め', 'ぬ', 'ね', 'の'],
        'answer': 'め',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangYaData() {
    return [
      ...
      },
      {
        ...
        'char': 'ヨ',
        'romaji': 'yo (Katakana)',
        'gif': 'assets/gifs/yok.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Yu" (Katakana)?',
        'options': ['ユ', 'コ', 'ヨ', 'ア'],
        'answer': 'ユ',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangRaData() {
    return [
      ...
      },
      {
        ...
        'char': 'レ',
        'romaji': 're (Katakana)',
        'gif': 'assets/gifs/rek.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Ru" (Hiragana)?',
        'options': ['る', 'ろ', 'そ', 'ゐ'],
        'answer': 'る',
      },
      {
  ...
  List<Map<String, dynamic>> _getHangWaNData() {
    return [
      ...
      },
      {
        ...
        'char': 'ン',
        'romaji': 'n (Katakana)',
        'gif': 'assets/gifs/nk.gif',
        'isHiragana': false,
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Wo" (Hiragana)?',
        'options': ['を', 'わ', 'ち', 'ん'],
        'answer': 'を',
      },
      {
  ...
  List<Map<String, dynamic>> _getFinalReviewData() {
    return [
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "O" (Hiragana)?',
        'options': ['あ', 'お', 'す', 'む'],
        'answer': 'お',
      },
      {
        'type': LessonType.quiz,
        'question': 'Chữ nào là "Ki" (Katakana)?',
        'options': ['キ', 'チ', 'ミ', 'ニ'],
        'answer': 'キ',
      },
      {
      ...
      {
        'type': LessonType.quiz,
        'question': 'Chọn chữ "N" (Katakana)',
        'options': ['シ', 'ツ', 'ソ', 'ン'],
        'answer': 'ン',
      },
      {
        'type': LessonType.quiz,
        'question': 'Chọn chữ "Shi" (Katakana)',
        'options': ['シ', 'ツ', 'ソ', 'ン'],
        'answer': 'シ',
      },
      {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Container(
                  width: 200, // Đã giảm kích thước để tránh tràn màn hình nhỏ
                  height: 200,
                  decoration: BoxDecoration(
                    color: Colors.white,
                ...
                IconButton(
                  ...
                  onPressed: () =>
                      SoundManager.instance.speakJapanese(data['char']),
                ),
              ],
            ),
          ),
          ...
          child: Row(
            children: [
              Expanded(
                child: ListView(
                  physics:
                      const BouncingScrollPhysics(), // Hiệu ứng cuộn mượt mà
                  children: leftItems
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(
              _isFlipped
                  ? "Tiếp tục"
                  : "Lật thẻ", // Chữ đổi linh hoạt theo ngữ cảnh
              style: const TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.bold,
                color: Colors.white,
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: GridView.builder(
            physics:
                const NeverScrollableScrollPhysics(), // Tắt cuộn để cố định
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 2,
              crossAxisSpacing: 16,
              mainAxisSpacing: 16,
      ...
      builder: (BuildContext context) {
        return Dialog(
          backgroundColor: const Color(
            0xFFFFF4C7,
          ), // Nền vàng pastel giống thiết kế
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(24),
          ),
          child: Padding(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () =>
                  SoundManager.instance.speakJapanese(widget.data['answer']),
              child: Container(
...
class _SpeakingPracticeViewState extends State<SpeakingPracticeView> {
  ...
  void _startListening() async {
    if (!_isAvailable) {
      bool initResult = await _speech.initialize();
      if (!initResult) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Thiết bị không hỗ trợ hoặc chưa cấp quyền Micro!"),
            ),
          );
        }
        return;
  ...
  void _checkAnswer() {
    if (_recognizedText.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Không nghe rõ, vui lòng thử lại!")),
      );
      return;
    }
