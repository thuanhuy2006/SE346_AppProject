...
class _LessonScreenState extends State<LessonScreen>{
  ...
  List<Map<String, dynamic>> _getHangAData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangKaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangSaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangTaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangNaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangHaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangMaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangYaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangRaData() { return [ /* Dữ liệu bạn đã có */ ]; }
  List<Map<String, dynamic>> _getHangWaNData() { return [ /* Dữ liệu bạn đã có */ ]; }
...
class _SpeakingPracticeViewState extends State<SpeakingPracticeView> {
  ...
  Future<String> _sendToWhisperAPI(String filePath) async {
    const String apiKey = 'sk-proj-YOUR_OPENAI_API_KEY';
