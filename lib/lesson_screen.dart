...
class _LessonScreenState extends State<LessonScreen> {
  ...
  void _loadLessonData() {
    switch (widget.lessonId) {
      ...
      case 'cb10_luyenviet':
        ...
        break;
      case 'n4_bai1_lythuyet':
        _activities = _getN4Bai1LyThuyetData();
        break;
      case 'n4_bai1_luyentap1':
        _activities = _getN4Bai1LuyenTap1Data();
        break;
      case 'n4_bai1_luyentap2':
        _activities = _getN4Bai1LuyenTap2Data();
        break;
      case 'n4_bai1_luyentap3':
        _activities = _getN4Bai1LuyenTap3Data();
        break;
      case 'n4_bai1_luyennoi':
        _activities = _getN4Bai1LuyenNoiData();
        break;
      case 'n4_bai1_luyenviet':
        _activities = _getN4Bai1LuyenVietData();
        break;

      case 'n4_bai2_lythuyet':
        _activities = _getN4Bai2LyThuyetData();
        break;
      case 'n4_bai2_luyentap1':
        _activities = _getN4Bai2LuyenTap1Data();
        break;
      case 'n4_bai2_luyentap2':
        _activities = _getN4Bai2LuyenTap2Data();
        break;
      case 'n4_bai2_luyentap3':
        _activities = _getN4Bai2LuyenTap3Data();
        break;
      case 'n4_bai2_luyennoi':
        _activities = _getN4Bai2LuyenNoiData();
        break;
      case 'n4_bai2_luyenviet':
        _activities = _getN4Bai2LuyenVietData();
        break;

      case 'n4_bai3_lythuyet':
        _activities = _getN4Bai3LyThuyetData();
        break;
      case 'n4_bai3_luyentap1':
        _activities = _getN4Bai3LuyenTap1Data();
        break;
      case 'n4_bai3_luyentap2':
        _activities = _getN4Bai3LuyenTap2Data();
        break;
      case 'n4_bai3_luyentap3':
        _activities = _getN4Bai3LuyenTap3Data();
        break;
      case 'n4_bai3_luyennoi':
        _activities = _getN4Bai3LuyenNoiData();
        break;
      case 'n4_bai3_luyenviet':
        _activities = _getN4Bai3LuyenVietData();
        break;

      case 'n4_bai4_lythuyet':
        _activities = _getN4Bai4LyThuyetData();
        break;
      case 'n4_bai4_luyentap1':
        _activities = _getN4Bai4LuyenTap1Data();
        break;
      case 'n4_bai4_luyentap2':
        _activities = _getN4Bai4LuyenTap2Data();
        break;
      case 'n4_bai4_luyentap3':
        _activities = _getN4Bai4LuyenTap3Data();
        break;
      case 'n4_bai4_luyennoi':
        _activities = _getN4Bai4LuyenNoiData();
        break;
      case 'n4_bai4_luyenviet':
        _activities = _getN4Bai4LuyenVietData();
        break;

      case 'n4_bai5_lythuyet':
        _activities = _getN4Bai5LyThuyetData();
        break;
      case 'n4_bai5_luyentap1':
        _activities = _getN4Bai5LuyenTap1Data();
        break;
      case 'n4_bai5_luyentap2':
        _activities = _getN4Bai5LuyenTap2Data();
        break;
      case 'n4_bai5_luyentap3':
        _activities = _getN4Bai5LuyenTap3Data();
        break;
      case 'n4_bai5_luyennoi':
        _activities = _getN4Bai5LuyenNoiData();
        break;
      case 'n4_bai5_luyenviet':
        _activities = _getN4Bai5LuyenVietData();
        break;

      case 'n4_bai6_lythuyet':
        _activities = _getN4Bai6LyThuyetData();
        break;
      case 'n4_bai6_luyentap1':
        _activities = _getN4Bai6LuyenTap1Data();
        break;
      case 'n4_bai6_luyentap2':
        _activities = _getN4Bai6LuyenTap2Data();
        break;
      case 'n4_bai6_luyentap3':
        _activities = _getN4Bai6LuyenTap3Data();
        break;
      case 'n4_bai6_luyennoi':
        _activities = _getN4Bai6LuyenNoiData();
        break;
      case 'n4_bai6_luyenviet':
        _activities = _getN4Bai6LuyenVietData();
        break;

      case 'n4_bai7_lythuyet':
        _activities = _getN4Bai7LyThuyetData();
        break;
      case 'n4_bai7_luyentap1':
        _activities = _getN4Bai7LuyenTap1Data();
        break;
      case 'n4_bai7_luyentap2':
        _activities = _getN4Bai7LuyenTap2Data();
        break;
      case 'n4_bai7_luyentap3':
        _activities = _getN4Bai7LuyenTap3Data();
        break;
      case 'n4_bai7_luyennoi':
        _activities = _getN4Bai7LuyenNoiData();
        break;
      case 'n4_bai7_luyenviet':
        _activities = _getN4Bai7LuyenVietData();
        break;

      case 'n4_bai8_lythuyet':
        _activities = _getN4Bai8LyThuyetData();
        break;
      case 'n4_bai8_luyentap1':
        _activities = _getN4Bai8LuyenTap1Data();
        break;
      case 'n4_bai8_luyentap2':
        _activities = _getN4Bai8LuyenTap2Data();
        break;
      case 'n4_bai8_luyentap3':
        _activities = _getN4Bai8LuyenTap3Data();
        break;
      case 'n4_bai8_luyennoi':
        _activities = _getN4Bai8LuyenNoiData();
        break;
      case 'n4_bai8_luyenviet':
        _activities = _getN4Bai8LuyenVietData();
        break;

      case 'n4_bai9_lythuyet':
        _activities = _getN4Bai9LyThuyetData();
        break;
      case 'n4_bai9_luyentap1':
        _activities = _getN4Bai9LuyenTap1Data();
        break;
      case 'n4_bai9_luyentap2':
        _activities = _getN4Bai9LuyenTap2Data();
        break;
      case 'n4_bai9_luyentap3':
        _activities = _getN4Bai9LuyenTap3Data();
        break;
      case 'n4_bai9_luyennoi':
        _activities = _getN4Bai9LuyenNoiData();
        break;
      case 'n4_bai9_luyenviet':
        _activities = _getN4Bai9LuyenVietData();
        break;

      case 'n4_bai10_lythuyet':
        _activities = _getN4Bai10LyThuyetData();
        break;
      case 'n4_bai10_luyentap1':
        _activities = _getN4Bai10LuyenTap1Data();
        break;
      case 'n4_bai10_luyentap2':
        _activities = _getN4Bai10LuyenTap2Data();
        break;
      case 'n4_bai10_luyentap3':
        _activities = _getN4Bai10LuyenTap3Data();
        break;
      case 'n4_bai10_luyennoi':
        _activities = _getN4Bai10LuyenNoiData();
        break;
      case 'n4_bai10_luyenviet':
        _activities = _getN4Bai10LuyenVietData();
        break;
      case 'n3_bai1_lythuyet':
        _activities = _getN3Bai1LyThuyetData();
        break;
      case 'n3_bai1_luyentap1':
        _activities = _getN3Bai1LuyenTap1Data();
        break;
      case 'n3_bai1_luyentap2':
        _activities = _getN3Bai1LuyenTap2Data();
        break;
      case 'n3_bai1_luyentap3':
        _activities = _getN3Bai1LuyenTap3Data();
        break;
      case 'n3_bai1_luyennoi':
        _activities = _getN3Bai1LuyenNoiData();
        break;
      case 'n3_bai1_luyenviet':
        _activities = _getN3Bai1LuyenVietData();
        break;

      case 'n3_bai2_lythuyet':
        _activities = _getN3Bai2LyThuyetData();
        break;
      case 'n3_bai2_luyentap1':
        _activities = _getN3Bai2LuyenTap1Data();
        break;
      case 'n3_bai2_luyentap2':
        _activities = _getN3Bai2LuyenTap2Data();
        break;
      case 'n3_bai2_luyentap3':
        _activities = _getN3Bai2LuyenTap3Data();
        break;
      case 'n3_bai2_luyennoi':
        _activities = _getN3Bai2LuyenNoiData();
        break;
      case 'n3_bai2_luyenviet':
        _activities = _getN3Bai2LuyenVietData();
        break;

      case 'n3_bai3_lythuyet':
        _activities = _getN3Bai3LyThuyetData();
        break;
      case 'n3_bai3_luyentap1':
        _activities = _getN3Bai3LuyenTap1Data();
        break;
      case 'n3_bai3_luyentap2':
        _activities = _getN3Bai3LuyenTap2Data();
        break;
      case 'n3_bai3_luyentap3':
        _activities = _getN3Bai3LuyenTap3Data();
        break;
      case 'n3_bai3_luyennoi':
        _activities = _getN3Bai3LuyenNoiData();
        break;
      case 'n3_bai3_luyenviet':
        _activities = _getN3Bai3LuyenVietData();
        break;

      case 'n3_bai4_lythuyet':
        _activities = _getN3Bai4LyThuyetData();
        break;
      case 'n3_bai4_luyentap1':
        _activities = _getN3Bai4LuyenTap1Data();
        break;
      case 'n3_bai4_luyentap2':
        _activities = _getN3Bai4LuyenTap2Data();
        break;
      case 'n3_bai4_luyentap3':
        _activities = _getN3Bai4LuyenTap3Data();
        break;
      case 'n3_bai4_luyennoi':
        _activities = _getN3Bai4LuyenNoiData();
        break;
      case 'n3_bai4_luyenviet':
        _activities = _getN3Bai4LuyenVietData();
        break;

      case 'n3_bai5_lythuyet':
        _activities = _getN3Bai5LyThuyetData();
        break;
      case 'n3_bai5_luyentap1':
        _activities = _getN3Bai5LuyenTap1Data();
        break;
      case 'n3_bai5_luyentap2':
        _activities = _getN3Bai5LuyenTap2Data();
        break;
      case 'n3_bai5_luyentap3':
        _activities = _getN3Bai5LuyenTap3Data();
        break;
      case 'n3_bai5_luyennoi':
        _activities = _getN3Bai5LuyenNoiData();
        break;
      case 'n3_bai5_luyenviet':
        _activities = _getN3Bai5LuyenVietData();
        break;

      case 'n3_bai6_lythuyet':
        _activities = _getN3Bai6LyThuyetData();
        break;
      case 'n3_bai6_luyentap1':
        _activities = _getN3Bai6LuyenTap1Data();
        break;
      case 'n3_bai6_luyentap2':
        _activities = _getN3Bai6LuyenTap2Data();
        break;
      case 'n3_bai6_luyentap3':
        _activities = _getN3Bai6LuyenTap3Data();
        break;
      case 'n3_bai6_luyennoi':
        _activities = _getN3Bai6LuyenNoiData();
        break;
      case 'n3_bai6_luyenviet':
        _activities = _getN3Bai6LuyenVietData();
        break;

      case 'n3_bai7_lythuyet':
        _activities = _getN3Bai7LyThuyetData();
        break;
      case 'n3_bai7_luyentap1':
        _activities = _getN3Bai7LuyenTap1Data();
        break;
      case 'n3_bai7_luyentap2':
        _activities = _getN3Bai7LuyenTap2Data();
        break;
      case 'n3_bai7_luyentap3':
        _activities = _getN3Bai7LuyenTap3Data();
        break;
      case 'n3_bai7_luyennoi':
        _activities = _getN3Bai7LuyenNoiData();
        break;
      case 'n3_bai7_luyenviet':
        _activities = _getN3Bai7LuyenVietData();
        break;

      case 'n3_bai8_lythuyet':
        _activities = _getN3Bai8LyThuyetData();
        break;
      case 'n3_bai8_luyentap1':
        _activities = _getN3Bai8LuyenTap1Data();
        break;
      case 'n3_bai8_luyentap2':
        _activities = _getN3Bai8LuyenTap2Data();
        break;
      case 'n3_bai8_luyentap3':
        _activities = _getN3Bai8LuyenTap3Data();
        break;
      case 'n3_bai8_luyennoi':
        _activities = _getN3Bai8LuyenNoiData();
        break;
      case 'n3_bai8_luyenviet':
        _activities = _getN3Bai8LuyenVietData();
        break;

      case 'n3_bai9_lythuyet':
        _activities = _getN3Bai9LyThuyetData();
        break;
      case 'n3_bai9_luyentap1':
        _activities = _getN3Bai9LuyenTap1Data();
        break;
      case 'n3_bai9_luyentap2':
        _activities = _getN3Bai9LuyenTap2Data();
        break;
      case 'n3_bai9_luyentap3':
        _activities = _getN3Bai9LuyenTap3Data();
        break;
      case 'n3_bai9_luyennoi':
        _activities = _getN3Bai9LuyenNoiData();
        break;
      case 'n3_bai9_luyenviet':
        _activities = _getN3Bai9LuyenVietData();
        break;

      case 'n3_bai10_lythuyet':
        _activities = _getN3Bai10LyThuyetData();
        break;
      case 'n3_bai10_luyentap1':
        _activities = _getN3Bai10LuyenTap1Data();
        break;
      case 'n3_bai10_luyentap2':
        _activities = _getN3Bai10LuyenTap2Data();
        break;
      case 'n3_bai10_luyentap3':
        _activities = _getN3Bai10LuyenTap3Data();
        break;
      case 'n3_bai10_luyennoi':
        _activities = _getN3Bai10LuyenNoiData();
        break;
      case 'n3_bai10_luyenviet':
        _activities = _getN3Bai10LuyenVietData();
        break;
      case 'n2_bai1_lythuyet':
        _activities = _getN2Bai1LyThuyetData();
        break;
      case 'n2_bai1_luyentap1':
        _activities = _getN2Bai1LuyenTap1Data();
        break;
      case 'n2_bai1_luyentap2':
        _activities = _getN2Bai1LuyenTap2Data();
        break;
      case 'n2_bai1_luyentap3':
        _activities = _getN2Bai1LuyenTap3Data();
        break;
      case 'n2_bai1_luyennoi':
        _activities = _getN2Bai1LuyenNoiData();
        break;
      case 'n2_bai1_luyenviet':
        _activities = _getN2Bai1LuyenVietData();
        break;

      case 'n2_bai2_lythuyet':
        _activities = _getN2Bai2LyThuyetData();
        break;
      case 'n2_bai2_luyentap1':
        _activities = _getN2Bai2LuyenTap1Data();
        break;
      case 'n2_bai2_luyentap2':
        _activities = _getN2Bai2LuyenTap2Data();
        break;
      case 'n2_bai2_luyentap3':
        _activities = _getN2Bai2LuyenTap3Data();
        break;
      case 'n2_bai2_luyennoi':
        _activities = _getN2Bai2LuyenNoiData();
        break;
      case 'n2_bai2_luyenviet':
        _activities = _getN2Bai2LuyenVietData();
        break;

      case 'n2_bai3_lythuyet':
        _activities = _getN2Bai3LyThuyetData();
        break;
      case 'n2_bai3_luyentap1':
        _activities = _getN2Bai3LuyenTap1Data();
        break;
      case 'n2_bai3_luyentap2':
        _activities = _getN2Bai3LuyenTap2Data();
        break;
      case 'n2_bai3_luyentap3':
        _activities = _getN2Bai3LuyenTap3Data();
        break;
      case 'n2_bai3_luyennoi':
        _activities = _getN2Bai3LuyenNoiData();
        break;
      case 'n2_bai3_luyenviet':
        _activities = _getN2Bai3LuyenVietData();
        break;

      case 'n2_bai4_lythuyet':
        _activities = _getN2Bai4LyThuyetData();
        break;
      case 'n2_bai4_luyentap1':
        _activities = _getN2Bai4LuyenTap1Data();
        break;
      case 'n2_bai4_luyentap2':
        _activities = _getN2Bai4LuyenTap2Data();
        break;
      case 'n2_bai4_luyentap3':
        _activities = _getN2Bai4LuyenTap3Data();
        break;
      case 'n2_bai4_luyennoi':
        _activities = _getN2Bai4LuyenNoiData();
        break;
      case 'n2_bai4_luyenviet':
        _activities = _getN2Bai4LuyenVietData();
        break;

      case 'n2_bai5_lythuyet':
        _activities = _getN2Bai5LyThuyetData();
        break;
      case 'n2_bai5_luyentap1':
        _activities = _getN2Bai5LuyenTap1Data();
        break;
      case 'n2_bai5_luyentap2':
        _activities = _getN2Bai5LuyenTap2Data();
        break;
      case 'n2_bai5_luyentap3':
        _activities = _getN2Bai5LuyenTap3Data();
        break;
      case 'n2_bai5_luyennoi':
        _activities = _getN2Bai5LuyenNoiData();
        break;
      case 'n2_bai5_luyenviet':
        _activities = _getN2Bai5LuyenVietData();
        break;

      case 'n2_bai6_lythuyet':
        _activities = _getN2Bai6LyThuyetData();
        break;
      case 'n2_bai6_luyentap1':
        _activities = _getN2Bai6LuyenTap1Data();
        break;
      case 'n2_bai6_luyentap2':
        _activities = _getN2Bai6LuyenTap2Data();
        break;
      case 'n2_bai6_luyentap3':
        _activities = _getN2Bai6LuyenTap3Data();
        break;
      case 'n2_bai6_luyennoi':
        _activities = _getN2Bai6LuyenNoiData();
        break;
      case 'n2_bai6_luyenviet':
        _activities = _getN2Bai6LuyenVietData();
        break;

      case 'n2_bai7_lythuyet':
        _activities = _getN2Bai7LyThuyetData();
        break;
      case 'n2_bai7_luyentap1':
        _activities = _getN2Bai7LuyenTap1Data();
        break;
      case 'n2_bai7_luyentap2':
        _activities = _getN2Bai7LuyenTap2Data();
        break;
      case 'n2_bai7_luyentap3':
        _activities = _getN2Bai7LuyenTap3Data();
        break;
      case 'n2_bai7_luyennoi':
        _activities = _getN2Bai7LuyenNoiData();
        break;
      case 'n2_bai7_luyenviet':
        _activities = _getN2Bai7LuyenVietData();
        break;

      case 'n2_bai8_lythuyet':
        _activities = _getN2Bai8LyThuyetData();
        break;
      case 'n2_bai8_luyentap1':
        _activities = _getN2Bai8LuyenTap1Data();
        break;
      case 'n2_bai8_luyentap2':
        _activities = _getN2Bai8LuyenTap2Data();
        break;
      case 'n2_bai8_luyentap3':
        _activities = _getN2Bai8LuyenTap3Data();
        break;
      case 'n2_bai8_luyennoi':
        _activities = _getN2Bai8LuyenNoiData();
        break;
      case 'n2_bai8_luyenviet':
        _activities = _getN2Bai8LuyenVietData();
        break;

      case 'n2_bai9_lythuyet':
        _activities = _getN2Bai9LyThuyetData();
        break;
      case 'n2_bai9_luyentap1':
        _activities = _getN2Bai9LuyenTap1Data();
        break;
      case 'n2_bai9_luyentap2':
        _activities = _getN2Bai9LuyenTap2Data();
        break;
      case 'n2_bai9_luyentap3':
        _activities = _getN2Bai9LuyenTap3Data();
        break;
      case 'n2_bai9_luyennoi':
        _activities = _getN2Bai9LuyenNoiData();
        break;
      case 'n2_bai9_luyenviet':
        _activities = _getN2Bai9LuyenVietData();
        break;

      case 'n2_bai10_lythuyet':
        _activities = _getN2Bai10LyThuyetData();
        break;
      case 'n2_bai10_luyentap1':
        _activities = _getN2Bai10LuyenTap1Data();
        break;
      case 'n2_bai10_luyentap2':
        _activities = _getN2Bai10LuyenTap2Data();
        break;
      case 'n2_bai10_luyentap3':
        _activities = _getN2Bai10LuyenTap3Data();
        break;
      case 'n2_bai10_luyennoi':
        _activities = _getN2Bai10LuyenNoiData();
        break;
      case 'n2_bai10_luyenviet':
        _activities = _getN2Bai10LuyenVietData();
        break;
      case 'n1_bai1_lythuyet':
        _activities = _getN1Bai1LyThuyetData();
        break;
      case 'n1_bai1_luyentap1':
        _activities = _getN1Bai1LuyenTap1Data();
        break;
      case 'n1_bai1_luyentap2':
        _activities = _getN1Bai1LuyenTap2Data();
        break;
      case 'n1_bai1_luyentap3':
        _activities = _getN1Bai1LuyenTap3Data();
        break;
      case 'n1_bai1_luyennoi':
        _activities = _getN1Bai1LuyenNoiData();
        break;
      case 'n1_bai1_luyenviet':
        _activities = _getN1Bai1LuyenVietData();
        break;

      case 'n1_bai2_lythuyet':
        _activities = _getN1Bai2LyThuyetData();
        break;
      case 'n1_bai2_luyentap1':
        _activities = _getN1Bai2LuyenTap1Data();
        break;
      case 'n1_bai2_luyentap2':
        _activities = _getN1Bai2LuyenTap2Data();
        break;
      case 'n1_bai2_luyentap3':
        _activities = _getN1Bai2LuyenTap3Data();
        break;
      case 'n1_bai2_luyennoi':
        _activities = _getN1Bai2LuyenNoiData();
        break;
      case 'n1_bai2_luyenviet':
        _activities = _getN1Bai2LuyenVietData();
        break;

      case 'n1_bai3_lythuyet':
        _activities = _getN1Bai3LyThuyetData();
        break;
      case 'n1_bai3_luyentap1':
        _activities = _getN1Bai3LuyenTap1Data();
        break;
      case 'n1_bai3_luyentap2':
        _activities = _getN1Bai3LuyenTap2Data();
        break;
      case 'n1_bai3_luyentap3':
        _activities = _getN1Bai3LuyenTap3Data();
        break;
      case 'n1_bai3_luyennoi':
        _activities = _getN1Bai3LuyenNoiData();
        break;
      case 'n1_bai3_luyenviet':
        _activities = _getN1Bai3LuyenVietData();
        break;

      case 'n1_bai4_lythuyet':
        _activities = _getN1Bai4LyThuyetData();
        break;
      case 'n1_bai4_luyentap1':
        _activities = _getN1Bai4LuyenTap1Data();
        break;
      case 'n1_bai4_luyentap2':
        _activities = _getN1Bai4LuyenTap2Data();
        break;
      case 'n1_bai4_luyentap3':
        _activities = _getN1Bai4LuyenTap3Data();
        break;
      case 'n1_bai4_luyennoi':
        _activities = _getN1Bai4LuyenNoiData();
        break;
      case 'n1_bai4_luyenviet':
        _activities = _getN1Bai4LuyenVietData();
        break;

      case 'n1_bai5_lythuyet':
        _activities = _getN1Bai5LyThuyetData();
        break;
      case 'n1_bai5_luyentap1':
        _activities = _getN1Bai5LuyenTap1Data();
        break;
      case 'n1_bai5_luyentap2':
        _activities = _getN1Bai5LuyenTap2Data();
        break;
      case 'n1_bai5_luyentap3':
        _activities = _getN1Bai5LuyenTap3Data();
        break;
      case 'n1_bai5_luyennoi':
        _activities = _getN1Bai5LuyenNoiData();
        break;
      case 'n1_bai5_luyenviet':
        _activities = _getN1Bai5LuyenVietData();
        break;

      case 'n1_bai6_lythuyet':
        _activities = _getN1Bai6LyThuyetData();
        break;
      case 'n1_bai6_luyentap1':
        _activities = _getN1Bai6LuyenTap1Data();
        break;
      case 'n1_bai6_luyentap2':
        _activities = _getN1Bai6LuyenTap2Data();
        break;
      case 'n1_bai6_luyentap3':
        _activities = _getN1Bai6LuyenTap3Data();
        break;
      case 'n1_bai6_luyennoi':
        _activities = _getN1Bai6LuyenNoiData();
        break;
      case 'n1_bai6_luyenviet':
        _activities = _getN1Bai6LuyenVietData();
        break;

      case 'n1_bai7_lythuyet':
        _activities = _getN1Bai7LyThuyetData();
        break;
      case 'n1_bai7_luyentap1':
        _activities = _getN1Bai7LuyenTap1Data();
        break;
      case 'n1_bai7_luyentap2':
        _activities = _getN1Bai7LuyenTap2Data();
        break;
      case 'n1_bai7_luyentap3':
        _activities = _getN1Bai7LuyenTap3Data();
        break;
      case 'n1_bai7_luyennoi':
        _activities = _getN1Bai7LuyenNoiData();
        break;
      case 'n1_bai7_luyenviet':
        _activities = _getN1Bai7LuyenVietData();
        break;

      case 'n1_bai8_lythuyet':
        _activities = _getN1Bai8LyThuyetData();
        break;
      case 'n1_bai8_luyentap1':
        _activities = _getN1Bai8LuyenTap1Data();
        break;
      case 'n1_bai8_luyentap2':
        _activities = _getN1Bai8LuyenTap2Data();
        break;
      case 'n1_bai8_luyentap3':
        _activities = _getN1Bai8LuyenTap3Data();
        break;
      case 'n1_bai8_luyennoi':
        _activities = _getN1Bai8LuyenNoiData();
        break;
      case 'n1_bai8_luyenviet':
        _activities = _getN1Bai8LuyenVietData();
        break;

      case 'n1_bai9_lythuyet':
        _activities = _getN1Bai9LyThuyetData();
        break;
      case 'n1_bai9_luyentap1':
        _activities = _getN1Bai9LuyenTap1Data();
        break;
      case 'n1_bai9_luyentap2':
        _activities = _getN1Bai9LuyenTap2Data();
        break;
      case 'n1_bai9_luyentap3':
        _activities = _getN1Bai9LuyenTap3Data();
        break;
      case 'n1_bai9_luyennoi':
        _activities = _getN1Bai9LuyenNoiData();
        break;
      case 'n1_bai9_luyenviet':
        _activities = _getN1Bai9LuyenVietData();
        break;

      case 'n1_bai10_lythuyet':
        _activities = _getN1Bai10LyThuyetData();
        break;
      case 'n1_bai10_luyentap1':
        _activities = _getN1Bai10LuyenTap1Data();
        break;
      case 'n1_bai10_luyentap2':
        _activities = _getN1Bai10LuyenTap2Data();
        break;
      case 'n1_bai10_luyentap3':
        _activities = _getN1Bai10LuyenTap3Data();
        break;
      case 'n1_bai10_luyennoi':
        _activities = _getN1Bai10LuyenNoiData();
        break;
      case 'n1_bai10_luyenviet':
        _activities = _getN1Bai10LuyenVietData();
        break;
      default:
        _activities = [];
    }
  ...
  List<Map<String, dynamic>> _getN4Bai1LyThuyetData() {
    return [
      ...
      // --- NHÓM TỪ 2: DANH TỪ ---
      {
        ...
        'example_jp': 'きれいな海です。',
        'example_rmj': 'Kirei na umi desu.',
        'example_vn': 'Là bãi biển đẹp.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'ピアノ',
        ...
        'example_jp': 'これはピアノです。',
        'example_rmj': 'Kore wa piano desu.',
        'example_vn': 'Đây là đàn piano.',
      },
      {
        'type': LessonType.listening,
        'options': ['うみ', 'ピアノ', 'ギター', 'はしります'],
        'answer': 'ギター',
      },
      ...
      // ================= PHẦN 2: NGỮ PHÁP =================
      {
        ...
        'grammars': [
          {
            'title': 'V (Thể Khả năng)',
            'meaning': 'Cách chia động từ Thể Khả Năng',
          },
    ...
    return [
      {
        ...
        'options': [
          ...
          {
            'img': 'assets/images/example_gitaa.png',
            'jp': 'ギター',
            'rmj': 'gitaa',
          },
          {
            'img': 'assets/images/example_oyogimasu.png',
            'jp': '泳ぎます',
            'rmj': 'oyogimasu',
          },
    ...
    return [
      ...
      },
      {
        ...
        'words': [
          ...
          'を',
          '弾きます',
        ], // Gây nhiễu bằng を và động từ thường
  ...
  List<Map<String, dynamic>> _getN4Bai1LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '海で泳ぎます。', 'answer': 'うみでおよぎます'},
      {
        'type': LessonType.speaking,
        'jp': '海で泳げます。',
        'answer': 'うみでおよげます', // Luyện phát âm khác biệt oyogimasu vs oyogemasu
      },
      {'type': LessonType.speaking, 'jp': 'ギターを弾きます。', 'answer': 'ぎたーをひきます'},
      {
        'type': LessonType.speaking,
        'jp': 'ギターが弾けます。',
        'answer': 'ぎたーがひけます', // Luyện đổi trợ từ o thành ga
      },
      {'type': LessonType.speaking, 'jp': '私は走れます。', 'answer': 'わたしははしれます'},
    ];
  }
  ...
  List<Map<String, dynamic>> _getN4Bai2LyThuyetData() {
    return [
      ...
      // --- NHÓM TỪ 1: ĐỘNG TỪ & DANH TỪ ---
      {
        ...
        'example_jp': '音楽が好きです。',
        'example_rmj': 'Ongaku ga suki desu.',
        'example_vn': 'Tôi thích âm nhạc.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '聞きます',
        ...
        'example_jp': '音楽を聞きます。',
        'example_rmj': 'Ongaku o kikimasu.',
        'example_vn': 'Tôi nghe nhạc.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '歩きます',
        ...
        'example_jp': '公園を歩きます。',
        'example_rmj': 'Kouen o arukimasu.',
        'example_vn': 'Tôi đi bộ ở công viên.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '働きます',
        'hiragana': 'はたらきます',
        'romaji': 'hatarakimasu',
        'options': ['ngủ', 'làm việc', 'đi bộ', 'nghe'],
        'answer': 'làm việc',
      },
      ...
      // --- NHÓM TỪ 2: TÍNH TỪ ---
      {
        ...
        'example_jp': '熱心な先生です。',
        'example_rmj': 'Nesshin na sensei desu.',
        'example_vn': 'Là giáo viên nhiệt tình.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '真面目[な]',
        ...
        'example_jp': '彼は真面目です。',
        'example_rmj': 'Kare wa majime desu.',
        'example_vn': 'Anh ấy rất nghiêm túc.',
      },
      {
        'type': LessonType.listening,
        'options': ['おんがく', 'ねっしん', 'まじめ', 'ききます'],
        'answer': 'まじめ',
      },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_ongaku.png',
            'jp': '音楽',
            'rmj': 'ongaku',
          },
          {
            'img': 'assets/images/example_kikimasu.png',
            'jp': '聞きます',
            'rmj': 'kikimasu',
          },
          {
            'img': 'assets/images/example_arukimasu.png',
            'jp': '歩きます',
            'rmj': 'arukimasu',
          },
          {
            'img': 'assets/images/example_hatarakimasu.png',
            'jp': '働きます',
            'rmj': 'hatarakimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Vừa làm việc vừa nghe nhạc): \n音楽を ( ... ) 働きます。',
  ...
  List<Map<String, dynamic>> _getN4Bai2LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '音楽を聞きます。', 'answer': 'おんがくをききます'},
      {
        'type': LessonType.speaking,
        'jp': '音楽を聞きながら歩きます。',
        'answer': 'おんがくをききながらあるきます',
      },
      {'type': LessonType.speaking, 'jp': '毎日働きます。', 'answer': 'まいにちはたらきます'},
      {'type': LessonType.speaking, 'jp': '熱心な人です。', 'answer': 'ねっしんなひとです'},
      {
        'type': LessonType.speaking,
        'jp': '彼は熱心だし、真面目です。',
  ...
  List<Map<String, dynamic>> _getN4Bai3LyThuyetData() {
    return [
      // ================= PHẦN 1: TỪ VỰNG =================
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'つくります',
            'romaji': 'tsukurimasu',
            'meaning': 'Làm / Chế tạo / Sáng lập',
          },
          {
            'kanji': '辞めます',
            'hiragana': 'やめます',
            'romaji': 'yamemasu',
            'meaning': 'Nghỉ (việc) / Bỏ',
          },
          {
            'kanji': '将来',
            'hiragana': 'しょうらい',
      ...
      // --- NHÓM TỪ 1: ĐỘNG TỪ ---
      {
        ...
        'example_jp': '自分で調べます。',
        'example_rmj': 'Jibun de shirabemasu.',
        'example_vn': 'Tôi tự mình tìm hiểu.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '作ります',
        ...
        'example_jp': '会社を作ります。',
        'example_rmj': 'Kaisha o tsukurimasu.',
        'example_vn': 'Tôi thành lập công ty.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '辞めます',
        'hiragana': 'やめます',
        'romaji': 'yamemasu',
        'options': ['nghỉ (việc)', 'tìm hiểu', 'làm việc', 'chế tạo'],
        'answer': 'nghỉ (việc)',
      },
      ...
      // --- NHÓM TỪ 2: DANH TỪ ---
      {
        ...
        'example_jp': '将来、日本へ行きます。',
        'example_rmj': 'Shourai, Nihon e ikimasu.',
        'example_vn': 'Tương lai tôi sẽ đi Nhật.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '夢',
        ...
        'example_jp': '私の夢です。',
        'example_rmj': 'Watashi no yume desu.',
        'example_vn': 'Đó là giấc mơ của tôi.',
      },
      {
        'type': LessonType.listening,
        'options': ['しょうらい', 'ゆめ', 'かいしゃ', 'しらべます'],
        'answer': 'かいしゃ',
      },
        ...
        'grammars': [
          {
            ...
            'meaning': 'Cùng làm... nào! (Thể ngắn của ましょう)',
          },
          {'title': 'V(ý hướng) + と思っています', 'meaning': 'Đang định làm gì'},
          {
            'title': 'V(rự/nai) + つもりです',
            'meaning': 'Định làm / Không định làm gì',
          },
        ],
      },
    ...
    return [
      {
        ...
        'options': [
          ...
          {
            'img': 'assets/images/example_shourai.png',
            'jp': '将来',
            'rmj': 'shourai',
          },
          {
            'img': 'assets/images/example_kaisha.png',
            'jp': '会社',
            'rmj': 'kaisha',
          },
          {
            'img': 'assets/images/example_shirabemasu.png',
            'jp': '調べます',
            'rmj': 'shirabemasu',
          },
        ],
  ...
  List<Map<String, dynamic>> _getN4Bai3LuyenNoiData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': '夢は何ですか。', 'answer': 'ゆめはなんですか'},
      {'type': LessonType.speaking, 'jp': '自分で調べます。', 'answer': 'じぶんでしらべます'},
    ];
  }
      ...
      },
      {
        ...
        'pairs': [
          ...
          {'left': 'Tác', 'right': '作'},
          {
            'left': 'Lai (Tương lai)',
            'right': '来',
          }, // Ôn chữ "Lai" (Đến) đã học ở N5, ghép thành Tương Lai
        ],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN4Bai4LyThuyetData() {
    return [
      ...
      // --- NHÓM TỪ 1: ĐỘNG TỪ ---
      {
        ...
        'example_jp': '毎日、運動します。',
        'example_rmj': 'Mainichi, undou shimasu.',
        'example_vn': 'Mỗi ngày tôi đều tập thể dục.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '休みます',
        ...
        'example_jp': '少し休みます。',
        'example_rmj': 'Sukoshi yasumimasu.',
        'example_vn': 'Tôi nghỉ ngơi một chút.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '運動します',
        'hiragana': 'うんどうします',
        'romaji': 'undoushimasu',
        'options': ['nghỉ ngơi', 'vận động', 'uống thuốc', 'bệnh'],
        'answer': 'vận động',
      },
      ...
      // --- NHÓM TỪ 2: SỨC KHỎE & TÌNH TRẠNG ---
      {
        ...
        'example_jp': '薬を飲みます。',
        'example_rmj': 'Kusuri o nomimasu.',
        'example_vn': 'Tôi uống thuốc.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '熱',
        ...
        'example_jp': '熱があります。',
        'example_rmj': 'Netsu ga arimasu.',
        'example_vn': 'Tôi bị sốt.',
      },
      {
        'type': LessonType.listening,
        'options': ['くすり', 'ねつ', 'びょうき', 'たぶん'],
        'answer': 'くすり',
      },
      ...
      // ================= PHẦN 2: NGỮ PHÁP =================
      {
        ...
        'grammars': [
          ...
          {
            'title': 'Thể thông thường + かもしれません',
            'meaning': 'Có lẽ là... / Biết đâu là...',
          },
        ],
      },
    ...
    return [
      {
        ...
        'options': [
          ...
          {
            'img': 'assets/images/example_kusuri.png',
            'jp': '薬',
            'rmj': 'kusuri',
          },
          {
            'img': 'assets/images/example_byouki.png',
            'jp': '病気',
            'rmj': 'byouki',
          },
          {
            'img': 'assets/images/example_yasumimasu.png',
            'jp': '休みます',
            'rmj': 'yasumimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền vào chỗ trống (Bạn NÊN uống thuốc): \n薬を ( ... ) ほうがいいです。',
  ...
  List<Map<String, dynamic>> _getN4Bai4LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '熱があります。', 'answer': 'ねつがあります'},
      {
        'type': LessonType.speaking,
        'jp': '休んだほうがいいです。',
        'answer': 'やすんだほうがいいです',
  ...
  List<Map<String, dynamic>> _getN4Bai5LyThuyetData() {
    return [
      // ================= PHẦN 1: TỪ VỰNG =================
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'いくら',
            'romaji': 'ikura',
            'meaning': 'Bao nhiêu (giá cả / mức độ)',
          },
        ],
      },
      ...
      // --- NHÓM TỪ 1: ĐỘNG TỪ ---
      {
        ...
        'example_jp': '雨が降ります。',
        'example_rmj': 'Ame ga furimasu.',
        'example_vn': 'Trời mưa (Mưa rơi).',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '考えます',
        ...
        'example_jp': '自分で考えます。',
        'example_rmj': 'Jibun de kangaemasu.',
        'example_vn': 'Tôi tự mình suy nghĩ.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '足ります',
        ...
        'example_jp': 'お金が足ります。',
        'example_rmj': 'Okane ga tarimasu.',
        'example_vn': 'Tiền đã đủ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '考えます',
        'hiragana': 'かんがえます',
        'romaji': 'kangaemasu',
        'options': ['rơi', 'suy nghĩ', 'đủ', 'vận động'],
        'answer': 'suy nghĩ',
      },
      ...
      // --- NHÓM TỪ 2: DANH TỪ & PHÓ TỪ ---
      {
        ...
        'example_jp': 'お金がありません。',
        'example_rmj': 'Okane ga arimasen.',
        'example_vn': 'Tôi không có tiền.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'いくら',
        'hiragana': 'いくら',
        'romaji': 'ikura',
        'meaning': 'Cho dù bao nhiêu...',
        'example_img': 'assets/images/example_ikura_temo.png',
        'example_jp': 'いくら考えても...',
        'example_rmj': 'Ikura kangaetemo...',
        'example_vn': 'Cho dù nghĩ bao nhiêu đi nữa...',
      },
      {
        'type': LessonType.listening,
        'options': ['あめ', 'おかね', 'いくら', 'たります'],
        'answer': 'おかね',
      },
    ...
    return [
      {
        ...
        'options': [
          ...
          {
            'img': 'assets/images/example_kangaemasu.png',
            'jp': '考えます',
            'rmj': 'kangaemasu',
          },
          {
            'img': 'assets/images/example_okane.png',
            'jp': 'お金',
            'rmj': 'okane',
          },
          {
            'img': 'assets/images/example_tarimasu.png',
            'jp': '足ります',
            'rmj': 'tarimasu',
          },
        ],
  ...
  List<Map<String, dynamic>> _getN4Bai5LuyenTap3Data() {
    return [
      ...
      },
      {
        ...
        'rmj': '',
        'audio_text':
            'いくら考えても、わかりません。', // Khớp với từ vựng wakarimasu đã học ở N5
  ...
  List<Map<String, dynamic>> _getN4Bai5LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '雨が降ります。', 'answer': 'あめがふります'},
      {
        'type': LessonType.speaking,
        'jp': '雨が降ったら、行きません。',
        'answer': 'あめがふったらいきません',
  ...
  List<Map<String, dynamic>> _getN4Bai6LyThuyetData() {
    return [
      ...
      // --- NHÓM TỪ 1: ĐỘNG TỪ TƯƠNG TÁC ---
      {
        ...
        'example_jp': '先生が褒めます。',
        'example_rmj': 'Sensei ga homemasu.',
        'example_vn': 'Giáo viên khen ngợi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '叱ります',
        ...
        'example_jp': '母が叱ります。',
        'example_rmj': 'Haha ga shikarimasu.',
        'example_vn': 'Mẹ mắng.',
      },
      {
        'type': LessonType.vocabQuiz,
        ...
        'hiragana': 'ふみます',
        'romaji': 'fumimasu',
        'options': ['ngủ', 'khen', 'giẫm / đạp', 'mắng'],
        'answer': 'giẫm / đạp',
      },
      ...
      // --- NHÓM TỪ 2: ĐỐI TƯỢNG ---
      {
        ...
        'example_jp': '日本語の先生です。',
        'example_rmj': 'Nihongo no sensei desu.',
        'example_vn': 'Là giáo viên tiếng Nhật.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '足',
        ...
        'example_jp': '私の足です。',
        'example_rmj': 'Watashi no ashi desu.',
        'example_vn': 'Là chân của tôi.',
      },
      {
        'type': LessonType.listening,
        'options': ['せんせい', 'こども', 'あし', 'ほめます'],
        'answer': 'こども',
      },
      ...
      // ================= PHẦN 2: NGỮ PHÁP =================
      {
        ...
        'grammars': [
          {
            'title': 'V (Thể Bị động)',
            'meaning': 'Cách chia động từ Thể Bị Động',
          },
          {'title': 'A は B に + V(bị động)', 'meaning': 'A bị/được B làm gì'},
          {
            'title': 'A は B に (Bộ phận) を + V(bị động)',
            'meaning': 'Bị tác động vào bộ phận cơ thể',
          },
        ],
      },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_sensei.png',
            'jp': '先生',
            'rmj': 'sensei',
          },
          {
            'img': 'assets/images/example_kodomo.png',
            'jp': '子供',
            'rmj': 'kodomo',
          },
          {'img': 'assets/images/example_ashi.png', 'jp': '足', 'rmj': 'ashi'},
          {
            'img': 'assets/images/example_homemasu.png',
            'jp': '褒めます',
            'rmj': 'homemasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền trợ từ đúng (Bị chó giẫm VÀO CHÂN): \n犬に足 ( ... ) 踏まれました。',
        'options': ['に', 'が', 'を', 'で'],
        'answer': 'を',
      },
      {
  ...
  List<Map<String, dynamic>> _getN4Bai6LuyenNoiData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': '母に叱られました。', 'answer': 'ははにしかられました'},
      {'type': LessonType.speaking, 'jp': '足を踏まれました。', 'answer': 'あしをふまれました'},
      {
        'type': LessonType.speaking,
        'jp': '犬に足を踏まれました。',
        'answer': 'いぬにあしをふまれました',
  ...
  List<Map<String, dynamic>> _getN4Bai7LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '町を案内します。',
        'example_rmj': 'Machi o annai shimasu.',
        'example_vn': 'Hướng dẫn (đi tham quan) thành phố.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '説明します',
        ...
        'example_jp': '文法を説明します。',
        'example_rmj': 'Bunpou o setsumei shimasu.',
        'example_vn': 'Giải thích ngữ pháp.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '荷物',
        'hiragana': 'にもつ',
        'romaji': 'nimotsu',
        'options': ['hướng dẫn', 'hành lý', 'bà cụ', 'chuẩn bị'],
        'answer': 'hành lý',
      },
      {
        'type': LessonType.grammarListIntro,
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_junbi.png',
            'jp': '準備',
            'rmj': 'junbi',
          },
          {
            'img': 'assets/images/example_nimotsu.png',
            'jp': '荷物',
            'rmj': 'nimotsu',
          },
          {
            'img': 'assets/images/example_annai.png',
            'jp': '案内',
            'rmj': 'annai',
          },
          {
            'img': 'assets/images/example_obaasan.png',
            'jp': 'お婆さん',
            'rmj': 'obaasan',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Bạn A đã Xách hành lý cho TÔI): \nAさんは荷物を持って ( ... )。',
  ...
  List<Map<String, dynamic>> _getN4Bai8LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '荷物が落ちそうです。',
        'example_rmj': 'Nimotsu ga ochisou desu.',
        'example_vn': 'Hành lý có vẻ sắp rơi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '破れます',
        ...
        'example_jp': '紙が破れました。',
        'example_rmj': 'Kami ga yaburemashita.',
        'example_vn': 'Tờ giấy đã bị rách.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '財布',
        'hiragana': 'さいふ',
        'romaji': 'saifu',
        'options': ['vui vẻ', 'cái ví', 'rơi rớt', 'buồn bã'],
        'answer': 'cái ví',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(bỏ ます) / A(bỏ い/な) + そうです',
            'meaning': 'Trông có vẻ... / Sắp sửa...',
          },
          {
            'title': 'V(て) + しまいました',
            'meaning': 'Lỡ (làm hỏng) / Xong (hoàn thành)',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'words': [
          ...
          {'kanji': '破れる', 'romaji': 'yabureru', 'meaning': 'rách'},
          {
            'kanji': '美味しそう',
            'romaji': 'oishisou',
            'meaning': 'trông có vẻ ngon',
          },
          {
            'kanji': '落としてしまう',
            'romaji': 'otoshite shimau',
            'meaning': 'lỡ đánh rơi',
          },
        ],
      },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_ureshii.png',
            'jp': '嬉しい',
            'rmj': 'ureshii',
          },
          {
            'img': 'assets/images/example_saifu.png',
            'jp': '財布',
            'rmj': 'saifu',
          },
          {
            'img': 'assets/images/example_ochiru.png',
            'jp': '落ちます',
            'rmj': 'ochimasu',
          },
          {
            'img': 'assets/images/example_kanashii.png',
            'jp': '悲しい',
            'rmj': 'kanashii',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Lỡ để quên đồ ở xe điện mất rồi): \n電車に忘れ物を ( ... )。',
  ...
  List<Map<String, dynamic>> _getN4Bai9LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '機械が動きます。',
        'example_rmj': 'Kikai ga ugokimasu.',
        'example_vn': 'Máy móc hoạt động.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '交差点',
        'hiragana': 'こうさてん',
        'romaji': 'kousaten',
        'options': ['con đường', 'máy móc', 'ngã tư', 'ấn nút'],
        'answer': 'ngã tư',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(ru) + と',
            'meaning': 'Hễ... thì... (Điều kiện tất yếu / Máy móc)',
          },
          {
            'title': 'V(た) + ら',
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_kikai.png',
            'jp': '機械',
            'rmj': 'kikai',
          },
          {'img': 'assets/images/example_michi.png', 'jp': '道', 'rmj': 'michi'},
          {
            'img': 'assets/images/example_kousaten.png',
            'jp': '交差点',
            'rmj': 'kousaten',
          },
          {
            'img': 'assets/images/example_ugokimasu.png',
            'jp': '動きます',
            'rmj': 'ugokimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Hễ rẽ phải sẽ có ngân hàng): \n右へ曲がる ( ... )、銀行があります。',
        'options': ['と', 'たら', 'なら', 'ば'],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Mẫu câu nào mang nghĩa "SAU KHI" một việc chắc chắn xảy ra?',
        'options': ['〜たら', '〜と', '〜なら', '〜ば'],
        'answer': '〜たら',
      },
      {
  ...
  List<Map<String, dynamic>> _getN4Bai10LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '早く逃げろ！',
        'example_rmj': 'Hayaku nigero!',
        'example_vn': 'Chạy trốn nhanh lên!',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '危ない',
        ...
        'example_jp': '危ないから、入るな。',
        'example_rmj': 'Abunai kara, hairu na.',
        'example_vn': 'Vì nguy hiểm nên không được vào.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '規則',
        'hiragana': 'きそく',
        'romaji': 'kisoku',
        'options': ['nguy hiểm', 'chạy trốn', 'quy tắc', 'tuân thủ'],
        'answer': 'quy tắc',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Thể mệnh lệnh (しろ / 飲め)',
            'meaning': 'Làm đi! (Ra lệnh mạnh mẽ)',
          },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_kisoku.png',
            'jp': '規則',
            'rmj': 'kisoku',
          },
          {
            'img': 'assets/images/example_nigeru.png',
            'jp': '逃げます',
            'rmj': 'nigemasu',
          },
          {
            'img': 'assets/images/example_abunai.png',
            'jp': '危ない',
            'rmj': 'abunai',
          },
          {
            'img': 'assets/images/example_nageru.png',
            'jp': '投げます',
            'rmj': 'nagemasu',
          },
        ],
  ...
  List<Map<String, dynamic>> _getN3Bai1LyThuyetData() {
    return [
      // ================= PHẦN 1: TỪ VỰNG =================
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'いらっしゃいます',
            'romaji': 'irasshaimasu',
            'meaning': 'Đi / Đến / Ở (Tôn kính của 行く, 来る, いる)',
          },
          {
            'kanji': '召し上がります',
            'hiragana': 'めしあがります',
          ...
          },
          {
            ...
            'hiragana': 'もうします',
            'romaji': 'moushimasu',
            'meaning': 'Nói / Tên là (Khiêm nhường của 言う)',
          },
        ],
      },
      ...
      // --- NHÓM TỪ 1: TÔN KÍNH NGỮ (Dùng cho người khác) ---
      {
        ...
        'example_jp': '社長が来ます。',
        'example_rmj': 'Shachou ga kimasu.',
        'example_vn': 'Giám đốc đến.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': 'いらっしゃいます',
        'hiragana': 'いらっしゃいます',
        'romaji': 'irasshaimasu',
        'meaning': 'Đi/Đến/Ở (Tôn kính)',
        'example_img': 'assets/images/example_irasshaimasu.png',
        'example_jp': '社長がいらっしゃいます。',
        'example_rmj': 'Shachou ga irasshaimasu.',
        'example_vn': 'Giám đốc đang ở đây / đang đến.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '召し上がります',
        'hiragana': 'めしあがります',
        'romaji': 'meshiagarimasu',
        'meaning': 'Ăn/Uống (Tôn kính)',
        'example_img': 'assets/images/example_meshiagarimasu.png',
        'example_jp': '先生が召し上がります。',
        'example_rmj': 'Sensei ga meshiagarimasu.',
        'example_vn': 'Thầy giáo dùng bữa.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '社長',
        'hiragana': 'しゃちょう',
        'romaji': 'shachou',
        'options': ['nhân viên', 'giáo viên', 'giám đốc', 'học sinh'],
        'answer': 'giám đốc',
      },
      ...
      // --- NHÓM TỪ 2: KHIÊM NHƯỜNG NGỮ (Dùng cho bản thân) ---
      {
        ...
        'example_jp': '私が参ります。',
        'example_rmj': 'Watashi ga mairimasu.',
        'example_vn': 'Tôi sẽ đi đến đó.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '拝見します',
        ...
        'example_jp': '資料を拝見します。',
        'example_rmj': 'Shiryou o haikenshimasu.',
        'example_vn': 'Tôi xin phép xem tài liệu.',
      },
      {
        'type': LessonType.listening,
        'options': ['いらっしゃいます', 'まいります', 'はいけんします', 'めしあがります'],
        'answer': 'まいります',
      },
        ...
        'grammars': [
          {
            ...
            'meaning': 'Dùng để nâng cao hành động của cấp trên/đối tác.',
          },
          {
            'title': '謙譲語 (Khiêm nhường ngữ)',
            'meaning': 'Dùng để hạ thấp hành động của bản thân mình.',
          },
        ],
      },
      ...
      // NGỮ PHÁP 1: TÔN KÍNH NGỮ
      {
        ...
        'title': 'TÔN KÍNH NGỮ',
        'formula':
            'Dùng các Động từ đặc biệt (いらっしゃる, 召し上がる...)\nHoặc: お + V(bỏ ます) + になります',
      ...
      // NGỮ PHÁP 2: KHIÊM NHƯỜNG NGỮ
      {
        ...
        'formula':
            'Dùng các Động từ đặc biệt (参る, 拝見する, 申す...)\nHoặc: お + V(bỏ ます) + します',
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_shachou.png',
            'jp': '社長',
            'rmj': 'shachou',
          },
          {
          ...
          {
            'img': 'assets/images/example_irasshaimasu.png',
            'jp': 'いらっしゃいます',
            'rmj': 'irasshaimasu',
          },
          {
    ...
    return [
      ...
      },
      {
        ...
        'options': [
          ...
          {
            'kanji': '私が召し上がります。',
            'hiragana': 'わたしがめしあがります。',
          }, // Bẫy: Tôn kính không dùng cho Watashi
        ],
        'answer': '社長が召し上がります。',
      },
      {
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Tôi xin phép xem tài liệu): \n私が資料を ( ... )。',
  ...
  List<Map<String, dynamic>> _getN3Bai1LuyenNoiData() {
    return [
      ...
      {'type': LessonType.speaking, 'jp': '私が参ります。', 'answer': 'わたしがまいります'},
      {
        'type': LessonType.speaking,
        'jp': '資料を拝見します。',
        'answer': 'しりょうをはいけんします',
  ...
  List<Map<String, dynamic>> _getN3Bai2LyThuyetData() {
    return [
      // ================= PHẦN 1: TỪ VỰNG =================
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'おかげで',
            'romaji': 'okagede',
            'meaning': 'Nhờ có... (Mang nghĩa biết ơn)',
          },
          {
            'kanji': 'せいで',
            'hiragana': 'せいで',
            'romaji': 'seide',
            'meaning': 'Tại vì... (Mang nghĩa trách móc)',
          },
        ],
      },
      ...
      // --- NHÓM TỪ 1: KẾT QUẢ ---
      {
        ...
        'example_jp': 'テストに成功しました。',
        'example_rmj': 'Tesuto ni seikoushimashita.',
        'example_vn': 'Tôi đã thành công trong bài kiểm tra.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '失敗します',
        ...
        'example_jp': '仕事に失敗しました。',
        'example_rmj': 'Shigoto ni shippaishimashita.',
        'example_vn': 'Tôi đã thất bại trong công việc.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '成功します',
        'hiragana': 'せいこうします',
        'romaji': 'seikoushimasu',
        'options': ['thất bại', 'tắc đường', 'thành công', 'tai nạn'],
        'answer': 'thành công',
      },
      ...
      // --- NHÓM TỪ 2: NGUYÊN NHÂN ---
      {
        ...
        'example_jp': '事故がありました。',
        'example_rmj': 'Jiko ga arimashita.',
        'example_vn': 'Đã xảy ra tai nạn.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '渋滞',
        ...
        'example_jp': '渋滞のせいで遅れました。',
        'example_rmj': 'Juutai no seide okuremashita.',
        'example_vn': 'Tôi đến muộn tại vì tắc đường.',
      },
      {
        'type': LessonType.listening,
        'options': ['せいこう', 'しっぱい', 'じこ', 'じゅうたい'],
        'answer': 'じこ',
      },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_seikou.png',
            'jp': '成功します',
            'rmj': 'seikoushimasu',
          },
          {
            'img': 'assets/images/example_shippai.png',
            'jp': '失敗します',
            'rmj': 'shippaishimasu',
          },
          {'img': 'assets/images/example_jiko.png', 'jp': '事故', 'rmj': 'jiko'},
          {
            'img': 'assets/images/example_juutai.png',
            'jp': '渋滞',
            'rmj': 'juutai',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Nhờ có bạn bè giúp đỡ...): \n友達の ( ... )、成功しました。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Tại vì tai nạn nên đường tắc): \n事故 ( ... ) 渋滞です。',
      ...
      },
      {
        ...
        'pairs': [
          ...
          {'left': 'Bại', 'right': '敗'},
          {
            'left': 'Trưởng',
            'right': '長',
          }, // Ôn lại chữ Trưởng (Giám đốc) ở Bài 1 N3
        ],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN3Bai3LyThuyetData() {
    return [
      // ================= PHẦN 1: TỪ VỰNG =================
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'つきます',
            'romaji': 'tsukimasu',
            'meaning': 'Nói (đi kèm với dối)',
          },
          {
            'kanji': '絶対',
            'hiragana': 'ぜったい',
            'romaji': 'zettai',
            'meaning': 'Tuyệt đối / Chắc chắn',
          },
          {
            'kanji': '会議',
            'hiragana': 'かいぎ',
      ...
      // --- NHÓM TỪ 1: HÀNH ĐỘNG ---
      {
        ...
        'example_jp': '約束を守ります。',
        'example_rmj': 'Yakusoku o mamorimasu.',
        'example_vn': 'Tôi giữ lời hứa.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '嘘',
      ...
      },
      {
        ...
        'hiragana': 'まもります',
        'romaji': 'mamorimasu',
        'options': ['bảo vệ', 'nói dối', 'cuộc họp', 'tuyệt đối'],
        'answer': 'bảo vệ',
      },
      ...
      // --- NHÓM TỪ 2: TÌNH HUỐNG ---
      {
        ...
        'example_jp': '絶対に勝つ。',
        'example_rmj': 'Zettai ni katsu.',
        'example_vn': 'Tuyệt đối (chắc chắn) sẽ thắng.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '会議',
        ...
        'example_jp': '会議に出ます。',
        'example_rmj': 'Kaigi ni demasu.',
        'example_vn': 'Tham gia cuộc họp.',
      },
      {
        'type': LessonType.listening,
        'options': ['やくそく', 'うそ', 'ぜったい', 'かいぎ'],
        'answer': 'かいぎ',
      },
      ...
      // ================= PHẦN 2: NGỮ PHÁP =================
      {
        ...
        'grammars': [
          {
            'title': 'Thể thông thường + はずです',
            'meaning': 'Chắc chắn là... (Phán đoán có căn cứ)',
          },
          {
            'title': 'V(từ điển) + べきです',
            'meaning': 'Nên / Cần phải... (Đạo lý, bổn phận)',
          },
        ],
      },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_yakusoku.png',
            'jp': '約束',
            'rmj': 'yakusoku',
          },
          {'img': 'assets/images/example_uso.png', 'jp': '嘘', 'rmj': 'uso'},
          {
            'img': 'assets/images/example_kaigi.png',
            'jp': '会議',
            'rmj': 'kaigi',
          },
          {
            'img': 'assets/images/example_zettai.png',
            'jp': '絶対',
            'rmj': 'zettai',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Anh ấy CHẮC CHẮN sẽ đến): \n彼は来る ( ... ) です。',
  ...
  List<Map<String, dynamic>> _getN3Bai3LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '約束を守ります。', 'answer': 'やくそくをまもります'},
      {'type': LessonType.speaking, 'jp': '嘘をつきません。', 'answer': 'うそをつきません'},
      {
        'type': LessonType.speaking,
        'jp': '今日は会議があるはずです。',
      ...
      },
      {
        ...
        'pairs': [
          ...
          {'left': 'Nghị', 'right': '議'},
          {
            'left': 'Hội',
            'right': '会',
          }, // Ôn lại Hội trong Công ty (N4) -> Hội Nghị (N3)
        ],
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN3Bai4LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': 'サッカーの試合です。',
        'example_rmj': 'Sakkā no shiai desu.',
        'example_vn': 'Trận đấu bóng đá.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '勝ちます',
        ...
        'example_jp': '試合に勝ちました。',
        'example_rmj': 'Shiai ni kachimashita.',
        'example_vn': 'Đã thắng trận đấu.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '負けます',
        'hiragana': 'まけます',
        'romaji': 'makemasu',
        'options': ['thắng', 'nghiêm khắc', 'thua', 'tin đồn'],
        'answer': 'thua',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Thể thông thường + そうです',
            'meaning': 'Nghe nói là... (Truyền đạt lại 100%)',
          },
          {
            'title': 'Thể thông thường + らしいです',
            'meaning': 'Nghe đồn là / Có vẻ như là...',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_shiai.png',
            'jp': '試合',
            'rmj': 'shiai',
          },
          {
            'img': 'assets/images/example_kachimasu.png',
            'jp': '勝ちます',
            'rmj': 'kachimasu',
          },
          {
            'img': 'assets/images/example_makemasu.png',
            'jp': '負けます',
            'rmj': 'makemasu',
          },
  ...
  List<Map<String, dynamic>> _getN3Bai4LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '試合に勝ちました。', 'answer': 'しあいにかちました'},
      {
        'type': LessonType.speaking,
        'jp': '試合に負けるそうです。',
        'answer': 'しあいまけるそうです',
  ...
  List<Map<String, dynamic>> _getN3Bai5LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '日本へ留学します。',
        'example_rmj': 'Nihon e ryuugakushimasu.',
        'example_vn': 'Tôi đi du học Nhật Bản.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '転勤します',
        ...
        'example_jp': '東京へ転勤します。',
        'example_rmj': 'Toukyou e tenkinshimasu.',
        'example_vn': 'Tôi chuyển công tác đến Tokyo.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '規則',
        'hiragana': 'きそく',
        'romaji': 'kisoku',
        'options': ['pháp luật', 'quy tắc', 'du học', 'quyết định'],
        'answer': 'quy tắc',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(ru/nai) + ことにする',
            'meaning': 'Tự mình quyết định làm gì',
          },
          {
            'title': 'V(ru/nai) + ことになる',
            'meaning': 'Được quyết định là / Trở thành quy định',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'vn':
            'Tôi ĐÃ ĐƯỢC QUYẾT ĐỊNH là sẽ chuyển công tác đến Tokyo (lệnh công ty).',
      },
      {
        'type': LessonType.vocabSummary,
        'words': [
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_tenkin.png',
            'jp': '転勤します',
            'rmj': 'tenkinshimasu',
          },
          {
            'img': 'assets/images/example_kimemasu.png',
            'jp': '決めます',
            'rmj': 'kimemasu',
          },
          {
            'img': 'assets/images/example_ryuugaku.png',
            'jp': '留学します',
            'rmj': 'ryuugakushimasu',
          },
          {
  ...
  List<Map<String, dynamic>> _getN3Bai5LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '転勤',
        'kanji_target': '勤',
        'meaning': 'Cần (Làm việc / Chuyên cần)',
        'rmj': 'kin / tsuto(meru)',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN3Bai6LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '子供が泣きます。',
        'example_rmj': 'Kodomo ga nakimasu.',
        'example_vn': 'Đứa trẻ khóc.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '心配します',
        ...
        'example_jp': '親を心配させます。',
        'example_rmj': 'Oya o shinpai sasemasu.',
        'example_vn': 'Làm cho bố mẹ lo lắng.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '怒ります',
        'hiragana': 'おこります',
        'romaji': 'okorimasu',
        'options': ['khóc', 'tức giận', 'tự do', 'lo lắng'],
        'answer': 'tức giận',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V (Thể Sai khiến)',
            'meaning': 'Nhóm 1: a+せる, Nhóm 2: させる',
          },
          {
            'title': 'A は B を/に + V(sai khiến)',
            'meaning': 'A bắt/cho phép B làm gì',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'words': [
          {'kanji': '泣かせる', 'romaji': 'nakaseru', 'meaning': 'làm cho khóc'},
          {
            'kanji': '怒らせる',
            'romaji': 'okoraseru',
            'meaning': 'làm cho tức giận',
          },
          {
            'kanji': '心配させる',
            'romaji': 'shinpaisaseru',
            'meaning': 'làm cho lo lắng',
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_nakimasu.png',
            'jp': '泣きます',
            'rmj': 'nakimasu',
          },
          {
            'img': 'assets/images/example_okorimasu.png',
            'jp': '怒ります',
            'rmj': 'okorimasu',
          },
          {
            'img': 'assets/images/example_shinpai.png',
            'jp': '心配させます',
            'rmj': 'shinpaisasemasu',
          },
          {
            'img': 'assets/images/example_jiyuu.png',
            'jp': '自由',
            'rmj': 'jiyuu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Giám đốc bắt tôi làm việc. Điền trợ từ: \n社長は私 ( ... ) 働かせます。',
        'options': ['に', 'が', 'を', 'で'],
  ...
  List<Map<String, dynamic>> _getN3Bai6LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_target': '怒',
        'meaning': 'Nộ (Tức giận)',
        'rmj': 'oko(rimasu) / ikari',
      },
      {
        'type': LessonType.kanjiDraw,
        'kanji_word': '心配',
        'kanji_target': '心',
        'meaning': 'Tâm (Trái tim / Tâm trí)',
        'rmj': 'shin / kokoro',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN3Bai7LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '１時間待たされました。',
        'example_rmj': 'Ichijikan matasaremashita.',
        'example_vn': 'Tôi BỊ BẮT CHỜ 1 tiếng đồng hồ.',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(bị động sai khiến)',
            'meaning': 'Cách chia: a+される / させられる',
          },
          {
            'title': 'A は B に V(bđ-sk)',
            'meaning': 'A BỊ B bắt làm việc gì đó (không muốn)',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'words': [
          ...
          {
            'kanji': '掃除させられる',
            'romaji': 'soujidasaserareru',
            'meaning': 'bị bắt dọn dẹp',
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_matsu.png',
            'jp': '待ちます',
            'rmj': 'machimasu',
          },
          {
            'img': 'assets/images/example_souji.png',
            'jp': '掃除します',
            'rmj': 'soujishimasu',
          },
  ...
  List<Map<String, dynamic>> _getN3Bai8LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '桜が咲けば...。',
        'example_rmj': 'Sakura ga sakeba...',
        'example_vn': 'Nếu hoa anh đào nở...',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(ば) / A(ければ)',
            'meaning': 'Nếu... (Điều kiện tự nhiên, tất yếu)',
          },
          {
            'title': 'N / A(な) + なら',
            'meaning': 'Nếu là... (Đưa ra lời khuyên)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          ...
          {
            'img': 'assets/images/example_sakura.png',
            'jp': '桜',
            'rmj': 'sakura',
          },
          {
            'img': 'assets/images/example_onsen.png',
            'jp': '温泉',
            'rmj': 'onsen',
          },
          {
            'img': 'assets/images/example_sakimasu.png',
            'jp': '咲きます',
            'rmj': 'sakimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Nếu là suối nước nóng thì...): \n温泉 ( ... ) 箱根がいいです。',
        'options': ['なら', 'ば', 'たら', 'ならは'],
        'answer': 'なら',
      },
      {
    ...
    return [
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'meaning': 'Đỗ / Đậu (kỳ thi)',
          },
          {
            'kanji': '痩せます',
            'hiragana': 'やせます',
            'romaji': 'yasemasu',
            'meaning': 'Giảm cân / Gầy đi',
          },
          {
            'kanji': '健康',
            'hiragana': 'けんこう',
      ...
      },
      {
        ...
        'example_jp': '車を買うために貯金します。',
        'example_rmj': 'Kuruma o kau tame ni chokin shimasu.',
        'example_vn': 'Tôi tiết kiệm tiền để mua xe.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '合格します',
        ...
        'example_jp': '試験に合格するように...。',
        'example_rmj': 'Shiken ni goukaku suru you ni...',
        'example_vn': 'Để có thể đỗ kỳ thi...',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '健康',
        'hiragana': 'けんこう',
        'romaji': 'kenkou',
        'options': ['sức khỏe', 'giảm cân', 'mục đích', 'tiết kiệm'],
        'answer': 'sức khỏe',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(ru) / N(の) + ために',
            'meaning': 'Để... (Mục đích rõ ràng, ý chí mạnh)',
          },
          {
            'title': 'V(khả năng/nai) + ように',
            'meaning': 'Để có thể... (Hướng tới trạng thái)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_goukaku.png',
            'jp': '合格します',
            'rmj': 'goukakushimasu',
          },
          {
            'img': 'assets/images/example_kenkou.png',
            'jp': '健康',
            'rmj': 'kenkou',
          },
          {
            'img': 'assets/images/example_yasemasu.png',
            'jp': '痩せます',
            'rmj': 'yasemasu',
          },
          {
            'img': 'assets/images/example_chokin.png',
            'jp': '貯金します',
            'rmj': 'chokinshimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Để MUA nhà thì tiết kiệm): \n家を ( ... ) ために、貯金します。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Để CÓ THỂ ĐỌC được báo Nhật): \n日本の新聞が ( ... ) ように、勉強します。',
    ...
    return [
      {
        'type': LessonType.speaking,
        'jp': '車を買うために貯金します。',
        'answer': 'くるまをかうためにちょきんします',
      },
      {
        'type': LessonType.speaking,
        'jp': '家族のために働きます。',
        'answer': 'かぞくのためにはたらきます',
      },
      {
        'type': LessonType.speaking,
        'jp': '日本語が話せるように勉強します。',
        'answer': 'にほんごがはなせるようにべんきょうします',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN3Bai9LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '健康',
        'kanji_target': '健',
        'meaning': 'Kiện (Tráng kiện / Khỏe mạnh)',
        'rmj': 'ken / suko(yaka)',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN3Bai10LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '日本の生活に慣れました。',
        'example_rmj': 'Nihon no seikatsu ni naremashita.',
        'example_vn': 'Tôi đã quen với cuộc sống ở Nhật.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '増えます',
        ...
        'example_jp': '外国人が増えています。',
        'example_rmj': 'Gaikokujin ga fueteimasu.',
        'example_vn': 'Người nước ngoài đang tăng lên.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '減ります',
        'hiragana': 'へります',
        'romaji': 'herimasu',
        'options': ['thay đổi', 'quen với', 'tăng lên', 'giảm đi'],
        'answer': 'giảm đi',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(khả năng/ru) + ようになる',
            'meaning': 'Trở nên (thay đổi trạng thái/khả năng)',
          },
          {
            'title': 'V(て) + いく / くる',
            'meaning': 'Sự biến đổi (Tiếp diễn ra xa / Tiến lại gần)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_fuemasu.png',
            'jp': '増えます',
            'rmj': 'fuemasu',
          },
          {
            'img': 'assets/images/example_herimasu.png',
            'jp': '減ります',
            'rmj': 'herimasu',
          },
          {
            'img': 'assets/images/example_kawarimasu.png',
            'jp': '変わります',
            'rmj': 'kawarimasu',
          },
          {
            'img': 'assets/images/example_naremasu.png',
            'jp': '慣れます',
            'rmj': 'naremasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Đã CÓ THỂ nói được tiếng Nhật): \n日本語が話せる ( ... ) なりました。',
        'options': ['こと', 'よう', 'ため', 'はず'],
        'answer': 'よう',
      },
      {
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Từ nay về sau, tôi sẽ tiếp tục cố gắng. Chọn cấu trúc đúng:',
    ...
    return [
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'かいてん',
            'romaji': 'kaiten',
            'meaning': 'Mở cửa hàng / Khai trương',
          },
          {
            'kanji': '出発',
            'hiragana': 'しゅっぱつ',
          ...
          },
          {
            ...
            'hiragana': 'さい',
            'romaji': 'sai',
            'meaning': 'Dịp / Khi (Trang trọng của 時)',
          },
          {
            'kanji': '挨拶',
            'hiragana': 'あいさつ',
            'romaji': 'aisatsu',
            'meaning': 'Chào hỏi / Lời phát biểu',
          },
        ],
      },
      {
        ...
        'example_jp': '契約にサインします。',
        'example_rmj': 'Keiyaku ni sain shimasu.',
        'example_vn': 'Ký vào hợp đồng.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '開店',
        ...
        'example_jp': '新しい店が開店します。',
        'example_rmj': 'Atarashii mise ga kaiten shimasu.',
        'example_vn': 'Cửa hàng mới khai trương.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '出発',
        'hiragana': 'しゅっぱつ',
        'romaji': 'shuppatsu',
        'options': ['hợp đồng', 'chào hỏi', 'xuất phát', 'dịp'],
        'answer': 'xuất phát',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'N / V(ru) + に際して',
            'meaning': 'Khi / Nhân dịp (Trang trọng)',
          },
          {
            'title': 'N / V(ru) + にあたって',
            'meaning': 'Nhân dịp (Hướng tới điều tích cực)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_kaiten.png',
            'jp': '開店',
            'rmj': 'kaiten',
          },
          {
            'img': 'assets/images/example_shuppatsu.png',
            'jp': '出発',
            'rmj': 'shuppatsu',
          },
          {
            'img': 'assets/images/example_aisatsu.png',
            'jp': '挨拶',
            'rmj': 'aisatsu',
          },
          {
            'img': 'assets/images/example_keiyaku.png',
            'jp': '契約',
            'rmj': 'keiyaku',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Cấu trúc nào mang ý nghĩa tích cực, dùng cho sự kiện bắt đầu (Khai trương, Xây dựng...)?',
  ...
  List<Map<String, dynamic>> _getN2Bai1LuyenNoiData() {
    return [
      ...
      },
      {
        'type': LessonType.speaking,
        'jp': '契約に際して、説明を読みます。',
        'answer': 'けいやくにさいしてせつめいをよみます',
      },
      {
        'type': LessonType.speaking,
        'jp': '開店にあたって、挨拶をします。',
        'answer': 'かいてんにあたってあいさつをします',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN2Bai1LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '開店',
        'kanji_target': '開',
        'meaning': 'Khai (Mở ra / Khai trương)',
        'rmj': 'kai / a(ku)',
      },
      {
        'type': LessonType.kanjiDraw,
        'kanji_word': '出発',
        'kanji_target': '発',
        'meaning': 'Phát (Xuất phát / Phát kiến)',
        'rmj': 'hatsu',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN2Bai2LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '試合に優勝しました。',
        'example_rmj': 'Shiai ni yuushoushimashita.',
        'example_vn': 'Đã vô địch trận đấu.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '犯人',
        ...
        'example_jp': '彼が犯人です。',
        'example_rmj': 'Kare ga hannin desu.',
        'example_vn': 'Hắn ta là thủ phạm.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '信じます',
        'hiragana': 'しんじます',
        'romaji': 'shinjimasu',
        'options': ['nói dối', 'nghiêm túc', 'tin tưởng', 'vô địch'],
        'answer': 'tin tưởng',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Thể thông thường + わけがない',
            'meaning': 'Tuyệt đối không / Không thể nào có chuyện...',
          },
          {
            'title': 'Thể thông thường + はずがない',
      ...
      },
      {
        ...
        'words': [
          ...
          {'kanji': '信じる', 'romaji': 'shinjiru', 'meaning': 'tin tưởng'},
          {
            'kanji': 'わけがない',
            'romaji': 'wake ga nai',
            'meaning': 'không thể nào có chuyện',
          },
          {
            'kanji': 'はずがない',
            'romaji': 'hazu ga nai',
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_yuushou.png',
            'jp': '優勝します',
            'rmj': 'yuushoushimasu',
          },
          {'img': 'assets/images/example_uso.png', 'jp': '嘘', 'rmj': 'uso'},
          {
            'img': 'assets/images/example_hannin.png',
            'jp': '犯人',
            'rmj': 'hannin',
          },
          {
            'img': 'assets/images/example_shinjimasu.png',
            'jp': '信じます',
            'rmj': 'shinjimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ đúng (Không thể nào có chuyện anh ấy là thủ phạm): \n彼が犯人 ( ... ) わけがない。',
        'options': ['の', 'な', 'だ', 'で'],
  ...
  List<Map<String, dynamic>> _getN2Bai2LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '彼が犯人です。', 'answer': 'かれがはんにんです'},
      {
        'type': LessonType.speaking,
        'jp': '彼が犯人のわけがない。',
        'answer': 'かれがはんにんのわけがない',
      },
      {
        'type': LessonType.speaking,
        'jp': 'あのチームが優勝するはずがない。',
        'answer': 'あのちーむがゆうしょうするはずがない',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN2Bai3LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '悪天候のせいで...。',
        'example_rmj': 'Akutenkou no sei de...',
        'example_vn': 'Tại vì thời tiết xấu...',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '努力します',
        ...
        'example_jp': '毎日努力します。',
        'example_rmj': 'Mainichi doryokushimasu.',
        'example_vn': 'Nỗ lực mỗi ngày.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '危険',
        'hiragana': 'きけん',
        'romaji': 'kiken',
        'options': ['biết', 'nỗ lực', 'nguy hiểm', 'quá sức'],
        'answer': 'nguy hiểm',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V/A/N + にもかかわらず',
            'meaning': 'Bất chấp / Mặc dù... (Trái với dự đoán)',
          },
          {
            'title': 'V(bỏ ます) + つつ(も)',
            'meaning': 'Mặc dù (biết là vậy) nhưng vẫn...',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_akutenkou.png',
            'jp': '悪天候',
            'rmj': 'akutenkou',
          },
          {
            'img': 'assets/images/example_kiken.png',
            'jp': '危険',
            'rmj': 'kiken',
          },
          {
            'img': 'assets/images/example_doryoku.png',
            'jp': '努力',
            'rmj': 'doryoku',
          },
          {'img': 'assets/images/example_muri.png', 'jp': '無理', 'rmj': 'muri'},
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Bất chấp thời tiết xấu, vẫn ra ngoài): \n悪天候 ( ... )、出かけました。',
    ...
    return [
      {
        'type': LessonType.speaking,
        'jp': '悪天候にもかかわらず。',
        'answer': 'あくてんこうにもかかわらず',
      },
      {
        'type': LessonType.speaking,
        'jp': '雨にもかかわらず出かけました。',
        'answer': 'あめにもかかわらずでかけました',
      },
      {
        'type': LessonType.speaking,
        'jp': '悪いと知りつつ、嘘をついた。',
        'answer': 'わるいとしりつつうそをついた',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN2Bai4LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '服が泥だらけです。',
        'example_rmj': 'Fuku ga dorodarake desu.',
        'example_vn': 'Quần áo đầy bùn.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '間違い',
        ...
        'example_jp': '間違いが多いです。',
        'example_rmj': 'Machigai ga ooi desu.',
        'example_vn': 'Có nhiều lỗi sai.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '傷',
        'hiragana': 'きず',
        'romaji': 'kizu',
        'options': ['bùn', 'vết thương', 'lỗi sai', 'chơi đùa'],
        'answer': 'vết thương',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Danh từ + だらけ',
            'meaning': 'Đầy / Toàn là (Mang nghĩa tiêu cực, bẩn)',
          },
      ...
      },
      {
        ...
        'words': [
          {'kanji': '泥だらけ', 'romaji': 'doro darake', 'meaning': 'đầy bùn'},
          {
            'kanji': '傷だらけ',
            'romaji': 'kizu darake',
            'meaning': 'đầy vết thương',
          },
          {
            'kanji': '間違いだらけ',
            'romaji': 'machigai darake',
            'meaning': 'đầy lỗi sai',
          },
          {
            'kanji': '遊んでばかり',
            'romaji': 'asonde bakari',
            'meaning': 'toàn chơi',
          },
          {
            'kanji': '文句ばかり',
            'romaji': 'monku bakari',
            'meaning': 'toàn phàn nàn',
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        'options': [
          ...
          {
            'img': 'assets/images/example_machigai.png',
            'jp': '間違い',
            'rmj': 'machigai',
          },
          {
            'img': 'assets/images/example_monku.png',
            'jp': '文句',
            'rmj': 'monku',
          },
        ],
  ...
  List<Map<String, dynamic>> _getN2Bai5LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': 'その意見に賛成です。',
        'example_rmj': 'Sono iken ni sansei desu.',
        'example_vn': 'Tôi tán thành ý kiến đó.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '反対します',
        ...
        'example_jp': '計画に反対します。',
        'example_rmj': 'Keikaku ni hantai shimasu.',
        'example_vn': 'Tôi phản đối kế hoạch này.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '田舎',
        'hiragana': 'いなか',
        'romaji': 'inaka',
        'options': ['đô thị', 'hiệu quả', 'tác dụng phụ', 'nông thôn'],
        'answer': 'nông thôn',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          ...
          {
            'title': 'Thể thông thường + 反面',
            'meaning': 'Mặt khác... (Hai mặt của 1 vấn đề)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_toshi.png',
            'jp': '都市',
            'rmj': 'toshi',
          },
          {
            'img': 'assets/images/example_inaka.png',
            'jp': '田舎',
            'rmj': 'inaka',
          },
          {
            'img': 'assets/images/example_sansei.png',
            'jp': '賛成',
            'rmj': 'sansei',
          },
          {
            'img': 'assets/images/example_hantai.png',
            'jp': '反対',
            'rmj': 'hantai',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Trái với anh trai, em gái lại hiếu động): \n兄が静かなの ( ... )、妹は元気だ。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Thuốc có hiệu quả nhưng mặt khác có tác dụng phụ. Điền từ:',
  ...
  List<Map<String, dynamic>> _getN2Bai5LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '反対',
        'kanji_target': '反',
        'meaning': 'Phản (Phản đối / Trái lại)',
        'rmj': 'han / so(ru)',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN2Bai6LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '一人で寂しいです。',
        'example_rmj': 'Hitori de sabishii desu.',
        'example_vn': 'Tôi buồn vì ở một mình.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '悔しい',
        'hiragana': 'くやしい',
        'romaji': 'kuyashii',
        'meaning': 'Cay cú / Tiếc nuối',
        'example_img': 'assets/images/example_kuyashii.png',
        'example_jp': '負けて悔しいです。',
        'example_rmj': 'Makete kuyashii desu.',
        'example_vn': 'Thua trận nên tôi rất cay cú.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '眠い',
        'hiragana': 'ねむい',
        'romaji': 'nemui',
        'options': ['cô đơn', 'tiếc nuối', 'lo lắng', 'buồn ngủ'],
        'answer': 'buồn ngủ',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          ...
          {
            'title': 'V/A(て) + しかたがない',
            'meaning': 'Rất... / Không biết làm sao',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'formula':
            'Động từ / Tính từ (chia về thể て) + しかたがない (shikata ga nai)',
        'meaning': 'Vô cùng... / Rất...',
      },
      {
        'type': LessonType.grammarUsage,
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_sabishii.png',
            'jp': '寂しい',
            'rmj': 'sabishii',
          },
          {
            'img': 'assets/images/example_nemui.png',
            'jp': '眠い',
            'rmj': 'nemui',
          },
          {
            'img': 'assets/images/example_kuyashii.png',
            'jp': '悔しい',
            'rmj': 'kuyashii',
          },
          {
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Lo lắng không biết làm sao): \nテストの結果が心配 ( ... ) しかたがない。',
        'options': ['で', 'て', 'くて', 'だ'],
  ...
  List<Map<String, dynamic>> _getN2Bai7LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '急いで行きます。',
        'example_rmj': 'Isoide ikimasu.',
        'example_vn': 'Tôi vội vàng đi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '油断します',
        ...
        'example_jp': '油断して負けた。',
        'example_rmj': 'Yudan shite maketa.',
        'example_vn': 'Vì chủ quan nên đã thua.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '傘',
        'hiragana': 'かさ',
        'romaji': 'kasa',
        'options': ['đồ bỏ quên', 'cái ô', 'vội vã', 'chủ quan'],
        'answer': 'cái ô',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(た) + ばかりに',
            'meaning': 'Chỉ vì... (Mà dẫn đến kết quả xấu, hối hận)',
          },
          {
            'title': 'Danh từ + に限って',
            'meaning': 'Đúng lúc / Riêng cái (ngày, người) đó thì lại...',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'words': [
          ...
          {'kanji': '傘', 'romaji': 'kasa', 'meaning': 'cái ô'},
          {
            'kanji': 'ばかりに',
            'romaji': 'bakari ni',
            'meaning': 'chỉ vì (hối hận)',
          },
          {
            'kanji': 'に限って',
            'romaji': 'ni kagitte',
            'meaning': 'đúng lúc thì lại',
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_isogimasu.png',
            'jp': '急ぎます',
            'rmj': 'isogimasu',
          },
          {'img': 'assets/images/example_kasa.png', 'jp': '傘', 'rmj': 'kasa'},
          {
            'img': 'assets/images/example_wasuremono.png',
            'jp': '忘れ物',
            'rmj': 'wasuremono',
          },
          {
            'img': 'assets/images/example_yudan.png',
            'jp': '油断します',
            'rmj': 'yudanshimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Chỉ vì chủ quan mà thất bại): \n油断した ( ... )、失敗した。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Đúng lúc vội thì xe buýt không tới): \n急いでいる時に ( ... )、バスが来ない。',
  ...
  List<Map<String, dynamic>> _getN2Bai7LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '油断して負けた。', 'answer': 'ゆだんしてまけた'},
      {
        'type': LessonType.speaking,
        'jp': '急いだばかりに、忘れ物をした。',
        'answer': 'いそいだばかりにわすれものをした',
      },
      {
        'type': LessonType.speaking,
        'jp': '傘がない日に限って、雨が降る。',
        'answer': 'かさがないひにかぎってあめがふる',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN2Bai8LyThuyetData() {
    return [
        ...
        'words': [
          {
            ...
            'hiragana': 'けいえいしゃ',
            'romaji': 'keieisha',
            'meaning': 'Nhà kinh doanh / Quản lý',
          },
          {
            'kanji': '消費者',
            'hiragana': 'しょうひしゃ',
      ...
      },
      {
        ...
        'example_jp': '消費者の意見を聞く。',
        'example_rmj': 'Shouhisha no iken o kiku.',
        'example_vn': 'Nghe ý kiến của người tiêu dùng.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '留学生',
        ...
        'example_jp': '日本に来た留学生です。',
        'example_rmj': 'Nihon ni kita ryuugakusei desu.',
        'example_vn': 'Là du học sinh đến Nhật.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '代表',
        'hiragana': 'だいひょう',
        'romaji': 'daihyou',
        'options': ['người tiêu dùng', 'nhà quản lý', 'đại diện', 'lập trường'],
        'answer': 'đại diện',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Danh từ + からいうと',
            'meaning': 'Xét từ góc độ / Lập trường của...',
          },
          {
            'title': 'Danh từ + として',
            'meaning': 'Với tư cách là / Nhằm mục đích...',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_shouhisha.png',
            'jp': '消費者',
            'rmj': 'shouhisha',
          },
          {
            'img': 'assets/images/example_ryuugakusei.png',
            'jp': '留学生',
            'rmj': 'ryuugakusei',
          },
          {
            'img': 'assets/images/example_keieisha.png',
            'jp': '経営者',
            'rmj': 'keieisha',
          },
          {
            'img': 'assets/images/example_daihyou.png',
            'jp': '代表',
            'rmj': 'daihyou',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Xét từ góc độ năng lực thì anh ấy là số 1): \n能力 ( ... )、彼が一番だ。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Đến Nhật với TƯ CÁCH LÀ đại diện): \n代表 ( ... ) 日本へ来ました。',
    ...
    return [
      {
        'type': LessonType.speaking,
        'jp': '消費者の意見を聞く。',
        'answer': 'しょうひしゃのいけんをきく',
      },
      {
        'type': LessonType.speaking,
        'jp': '消費者の立場からいうと。',
        'answer': 'しょうひしゃのたちばからいうと',
      },
      {
        'type': LessonType.speaking,
        'jp': '留学生として日本に来ました。',
        'answer': 'りゅうがくせいとしてにほんにきました',
      },
    ];
  }
    ...
    return [
      {
        ...
        'kanji_word': '経営',
        'kanji_target': '経',
        'meaning': 'Kinh (Kinh doanh / Kinh tế)',
        'rmj': 'kei / he(ru)',
      },
      {
        'type': LessonType.kanjiDraw,
        'kanji_word': '経営',
        'kanji_target': '営',
        'meaning': 'Doanh (Kinh doanh / Quản lý)',
        'rmj': 'ei / itona(mu)',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN2Bai9LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '彼に謝ります。',
        'example_rmj': 'Kare ni ayamarimasu.',
        'example_vn': 'Xin lỗi anh ấy.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '諦めます',
        ...
        'example_jp': '夢を諦めます。',
        'example_rmj': 'Yume o akiramemasu.',
        'example_vn': 'Từ bỏ giấc mơ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '感動します',
        'hiragana': 'かんどうします',
        'romaji': 'kandoushimasu',
        'options': ['xin lỗi', 'cảm động', 'từ bỏ', 'hủy bỏ'],
        'answer': 'cảm động',
      },
      {
        'type': LessonType.grammarListIntro,
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_ayamarimasu.png',
            'jp': '謝ります',
            'rmj': 'ayamarimasu',
          },
          {
            'img': 'assets/images/example_akiramemasu.png',
            'jp': '諦めます',
            'rmj': 'akiramemasu',
          },
          {
            'img': 'assets/images/example_chuushi.png',
            'jp': '中止',
            'rmj': 'chuushi',
          },
          {
            'img': 'assets/images/example_kandou.png',
            'jp': '感動します',
            'rmj': 'kandoushimasu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Cảm động không thể kìm nén được): \n感動 ( ... ) にはいられない。',
  ...
  List<Map<String, dynamic>> _getN2Bai10LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '単なる冗談です。',
        'example_rmj': 'Tannaru joudan desu.',
        'example_vn': 'Đơn thuần chỉ là một trò đùa thôi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '誤解',
        ...
        'example_jp': 'それは誤解です。',
        'example_rmj': 'Sore wa gokai desu.',
        'example_vn': 'Đó là sự hiểu lầm.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '結果',
        'hiragana': 'けっか',
        'romaji': 'kekka',
        'options': ['trò đùa', 'tình yêu', 'kết quả', 'hiểu lầm'],
        'answer': 'kết quả',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V/N + にすぎない',
            'meaning': 'Chẳng qua chỉ là... (Đánh giá thấp mức độ)',
          },
          {
            'title': 'N + にほかならない',
            'meaning':
                'Chính là... / Không gì khác ngoài... (Nhấn mạnh tuyệt đối)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_joudan.png',
            'jp': '冗談',
            'rmj': 'joudan',
          },
          {
            'img': 'assets/images/example_gokai.png',
            'jp': '誤解',
            'rmj': 'gokai',
          },
          {
            'img': 'assets/images/example_kekka.png',
            'jp': '結果',
            'rmj': 'kekka',
          },
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Cấu trúc mang ý nghĩa nhấn mạnh tuyệt đối (Chính là / Không gì khác ngoài):',
  ...
  List<Map<String, dynamic>> _getN2Bai10LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '冗談',
        'kanji_target': '談',
        'meaning': 'Đàm (Đàm thoại / Thảo luận)',
        'rmj': 'dan',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN1Bai1LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '無礼な態度です。',
        'example_rmj': 'Burei na taido desu.',
        'example_vn': 'Đó là một thái độ vô lễ.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '記録',
        ...
        'example_jp': '記録ずくめです。',
        'example_rmj': 'Kiroku zukume desu.',
        'example_vn': 'Toàn là kỷ lục mới.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '危険',
        'hiragana': 'きけん',
        'romaji': 'kiken',
        'options': ['vô lễ', 'kỷ lục', 'nguy hiểm', 'màu đen'],
        'answer': 'nguy hiểm',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'A(な) + 極まる / 極まりない',
            'meaning': 'Cực kỳ... / Vô cùng... (Đạt đến giới hạn)',
          },
      ...
      },
      {
        ...
        'words': [
          {
            'kanji': '無礼極まりない',
            'romaji': 'burei kiwamarinai',
            'meaning': 'hết sức vô lễ',
          },
          {
            'kanji': '危険極まりない',
            'romaji': 'kiken kiwamarinai',
            'meaning': 'cực kỳ nguy hiểm',
          },
          {'kanji': '黒ずくめ', 'romaji': 'kuro zukume', 'meaning': 'toàn màu đen'},
          {
            'kanji': '記録ずくめ',
            'romaji': 'kiroku zukume',
            'meaning': 'toàn là kỷ lục',
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_burei.png',
            'jp': '無礼',
            'rmj': 'burei',
          },
          {
          ...
          {
            'img': 'assets/images/example_kiroku.png',
            'jp': '記録',
            'rmj': 'kiroku',
          },
          {
            'img': 'assets/images/example_shiawase.png',
            'jp': '幸せ',
            'rmj': 'shiawase',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Người đàn ông mặc toàn đồ đen): \n黒 ( ... ) の男が立っている。',
    ...
    return [
      {
        'type': LessonType.speaking,
        'jp': '態度は無礼極まりない。',
        'answer': 'たいどはぶれいきわまりない',
      },
      {
        'type': LessonType.speaking,
        'jp': '危険極まりない行為だ。',
        'answer': 'きけんきわまりないこういだ',
      },
  ...
  List<Map<String, dynamic>> _getN1Bai2LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '涙が流れる。',
        'example_rmj': 'Namida ga nagareru.',
        'example_vn': 'Nước mắt tuôn rơi.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '辞任',
        ...
        'example_jp': '社長が辞任した。',
        'example_rmj': 'Shachou ga jinin shita.',
        'example_vn': 'Giám đốc đã từ chức.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '災害',
        'hiragana': 'さいがい',
        'romaji': 'saigai',
        'options': ['đồng tình', 'nước mắt', 'thảm họa', 'từ chức'],
        'answer': 'thảm họa',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          ...
          {
            'title': 'N + を余儀なくされる',
            'meaning': 'Bị buộc phải... (Tình thế bất khả kháng)',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'words': [
          ...
          {'kanji': '辞任', 'romaji': 'jinin', 'meaning': 'từ chức'},
          {
            'kanji': '禁じ得ない',
            'romaji': 'kinjienai',
            'meaning': 'không kìm nén được',
          },
          {
            'kanji': '余儀なくされる',
            'romaji': 'yoginaku sareru',
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_namida.png',
            'jp': '涙',
            'rmj': 'namida',
          },
          {
            'img': 'assets/images/example_saigai.png',
            'jp': '災害',
            'rmj': 'saigai',
          },
          {
            'img': 'assets/images/example_jinin.png',
            'jp': '辞任',
            'rmj': 'jinin',
          },
          {
            'img': 'assets/images/example_doujou.png',
            'jp': '同情',
            'rmj': 'doujou',
          },
        ],
  ...
  List<Map<String, dynamic>> _getN1Bai3LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '感謝の気持ちを伝える。',
        'example_rmj': 'Kansha no kimochi o tsutaeru.',
        'example_vn': 'Truyền đạt lòng biết ơn.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '孤独',
        ...
        'example_jp': '孤独を感じる。',
        'example_rmj': 'Kodoku o kanjiru.',
        'example_vn': 'Cảm thấy cô độc.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '嬉しい',
        'hiragana': 'うれしい',
        'romaji': 'ureshii',
        'options': ['cô độc', 'lạnh', 'biết ơn', 'vui sướng'],
        'answer': 'vui sướng',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Danh từ / Thể thông thường + とはいえ',
            'meaning': 'Mặc dù nói là... nhưng...',
          },
          {
            'title': 'Tính từ + 限りだ',
            'meaning': 'Cực kỳ... / Rất... (Cảm xúc tối đa)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_kansha.png',
            'jp': '感謝',
            'rmj': 'kansha',
          },
          {
            'img': 'assets/images/example_kodoku.png',
            'jp': '孤独',
            'rmj': 'kodoku',
          },
          {
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Mặc dù nói là mùa xuân nhưng vẫn lạnh): \n春 ( ... )、まだ寒い。',
  ...
  List<Map<String, dynamic>> _getN1Bai4LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '天候に恵まれる。',
        'example_rmj': 'Tenkou ni megumareru.',
        'example_vn': 'Được thời tiết ưu ái.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '怠ける',
        ...
        'example_jp': '仕事を怠ける。',
        'example_rmj': 'Shigoto o namakeru.',
        'example_vn': 'Lười biếng trong công việc.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '批判',
        'hiragana': 'ひはん',
        'romaji': 'hihan',
        'options': ['thời tiết', 'tham dự', 'lười biếng', 'phê phán'],
        'answer': 'phê phán',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'Danh từ + にかかわらず',
            'meaning': 'Bất kể... / Không liên quan đến...',
          },
          {
            'title': 'V(ru) / N(の) + きらいがある',
            'meaning': 'Có khuynh hướng... (Thường là thói quen xấu)',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_tenkou.png',
            'jp': '天候',
            'rmj': 'tenkou',
          },
          {
            'img': 'assets/images/example_shusseki.png',
            'jp': '出席',
            'rmj': 'shusseki',
          },
          {
            'img': 'assets/images/example_hihan.png',
            'jp': '批判',
            'rmj': 'hihan',
          },
          {
            'img': 'assets/images/example_namakeru.png',
            'jp': '怠ける',
            'rmj': 'namakeru',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Bất kể nam nữ đều có thể tham gia): \n男女 ( ... ) 参加できる。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Cấu trúc chỉ một "tật xấu" hay một "khuynh hướng tiêu cực":',
    ...
    return [
      {
        'type': LessonType.speaking,
        'jp': '天候にかかわらず、試合を行います。',
        'answer': 'てんこうにかかわらずしあいをおこないます',
      },
      {
        'type': LessonType.speaking,
        'jp': '彼は怠けるきらいがある。',
        'answer': 'かれはなまけるきらいがある',
      },
      {
        'type': LessonType.speaking,
        'jp': '男女にかかわらず参加できます。',
        'answer': 'だんじょにかかわらずさんかできます',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN1Bai4LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '怠ける',
        'kanji_target': '怠',
        'meaning': 'Đãi (Lười biếng / Lơ đễnh)',
        'rmj': 'nama(keru) / tai',
      },
      {
        'type': LessonType.kanjiDraw,
      ...
      },
      {
        ...
        'kanji_word': '批判',
        'kanji_target': '判',
        'meaning': 'Phán (Phán đoán / Đánh giá)',
        'rmj': 'han / ban',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN1Bai5LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '公園を散歩する。',
        'example_rmj': 'Kouen o sanpo suru.',
        'example_vn': 'Đi dạo công viên.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '報告',
        ...
        'example_jp': '結果を報告します。',
        'example_rmj': 'Kekka o houkoku shimasu.',
        'example_vn': 'Báo cáo kết quả.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'お見舞い',
        'hiragana': 'おみまい',
        'romaji': 'omimai',
        'options': ['chào hỏi', 'đi dạo', 'thăm bệnh', 'báo cáo'],
        'answer': 'thăm bệnh',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(bỏ ます) / N + がてら',
            'meaning': 'Nhân tiện... thì (Văn nói/viết chung)',
          },
          {
            'title': 'N + かたがた',
            'meaning': 'Nhân tiện... (Văn phong vô cùng trang trọng)',
          },
        ],
      },
      {
        ...
        'words': [
          {
            'kanji': '散歩がてら',
            'romaji': 'sanpo gatera',
            'meaning': 'nhân tiện đi dạo',
          },
          {
            'kanji': '挨拶かたがた',
            'romaji': 'aisatsu katagata',
            'meaning': 'nhân tiện chào hỏi',
          },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_sanpo.png',
            'jp': '散歩',
            'rmj': 'sanpo',
          },
          {
          ...
          {
            'img': 'assets/images/example_houkoku.png',
            'jp': '報告',
            'rmj': 'houkoku',
          },
          {
            'img': 'assets/images/example_omimai.png',
            'jp': 'お見舞い',
            'rmj': 'omimai',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Nhân tiện đi dạo thì mua đồ): \n散歩 ( ... )、買い物をする。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Cấu trúc "Nhân tiện" nào mang tính chất TRANG TRỌNG (Business) nhất?',
    ...
    return [
      {
        'type': LessonType.speaking,
        'jp': '散歩がてら買い物をする。',
        'answer': 'さんぽがてらかいものをすること',
      },
      {
        'type': LessonType.speaking,
        'jp': 'ご挨拶かたがた、伺いました。',
        'answer': 'ごあいさつかたがたうかがいました',
      },
      {
        'type': LessonType.speaking,
        'jp': '報告かたがたお会いしたいです。',
        'answer': 'ほうこくかたがたおあいしたいです',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN1Bai6LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '体力の限界です。',
        'example_rmj': 'Tairyoku no genkai desu.',
        'example_vn': 'Đã đến giới hạn của thể lực.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '影響',
        ...
        'example_jp': '影響を与える。',
        'example_rmj': 'Eikyou o ataeru.',
        'example_vn': 'Gây ảnh hưởng.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': 'つま先',
        'hiragana': 'つまさき',
        'romaji': 'tsumasaki',
        'options': ['giới hạn', 'ảnh hưởng', 'đầu ngón chân', 'nghỉ việc'],
        'answer': 'đầu ngón chân',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'N(thời gian) + を限りに',
            'meaning': 'Đến hết... (Làm mốc kết thúc)',
          },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_genkai.png',
            'jp': '限界',
            'rmj': 'genkai',
          },
          {
            'img': 'assets/images/example_eikyou.png',
            'jp': '影響',
            'rmj': 'eikyou',
          },
          {'img': 'assets/images/example_atama.png', 'jp': '頭', 'rmj': 'atama'},
          {
            'img': 'assets/images/example_tsumasaki.png',
            'jp': 'つま先',
            'rmj': 'tsumasaki',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Đến hết hôm nay thì bỏ thuốc): \n今日 ( ... ) タバコを辞める。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Lan rộng đến tận ngón chân): \nつま先 ( ... ) 泥だらけだ。',
  ...
  List<Map<String, dynamic>> _getN1Bai6LuyenVietData() {
    return [
      ...
      },
      {
        ...
        'kanji_word': '限界',
        'kanji_target': '界',
        'meaning': 'Giới (Thế giới / Ranh giới)',
        'rmj': 'kai',
      },
      {
        'type': LessonType.kanjiDraw,
        'kanji_word': '影響',
        'kanji_target': '影',
        'meaning': 'Ảnh (Cái bóng / Ảnh hưởng)',
        'rmj': 'kage / ei',
      },
      {
        'type': LessonType.kanjiDraw,
        'kanji_word': '影響',
        'kanji_target': '響',
        'meaning': 'Hưởng (Âm vang / Ảnh hưởng)',
        'rmj': 'hibi(ku) / kyou',
      },
    ];
  }
  ...
  List<Map<String, dynamic>> _getN1Bai7LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '罰を受ける。',
        'example_rmj': 'Batsu o ukeru.',
        'example_vn': 'Chịu phạt.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '優秀',
        'hiragana': 'ゆうしゅう',
        'romaji': 'yuushuu',
        'options': ['đương nhiên', 'tội phạm', 'xuất sắc', 'hình phạt'],
        'answer': 'xuất sắc',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'N (の) / V + ゆえ（に）',
            'meaning': 'Do / Vì... (Văn phong cổ, học thuật)',
          },
          {
            'title': 'V(て) + しかるべきだ',
            'meaning': 'Đáng lẽ phải / Làm thế là đương nhiên',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'words': [
          ...
          {'kanji': '犯罪', 'romaji': 'hanzai', 'meaning': 'tội phạm'},
          {
            'kanji': 'ゆえに',
            'romaji': 'yue ni',
            'meaning': 'vì / do (trang trọng)',
          },
          {
            'kanji': 'てしかるべきだ',
            'romaji': 'te shikarubeki da',
            'meaning': 'làm thế là đương nhiên',
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_mazushisa.png',
            'jp': '貧しさ',
            'rmj': 'mazushisa',
          },
          {
            'img': 'assets/images/example_hanzai.png',
            'jp': '犯罪',
            'rmj': 'hanzai',
          },
          {'img': 'assets/images/example_batsu.png', 'jp': '罰', 'rmj': 'batsu'},
          {
            'img': 'assets/images/example_yuushuu.png',
            'jp': '優秀',
            'rmj': 'yuushuu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Vì quá xuất sắc nên bị ghen tị): \n優秀である ( ... )、嫉妬される。',
  ...
  List<Map<String, dynamic>> _getN1Bai8LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '命を大切にする。',
        'example_rmj': 'Inochi o taisetsu ni suru.',
        'example_vn': 'Trân trọng mạng sống.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '信頼',
        ...
        'example_jp': '彼を信頼している。',
        'example_rmj': 'Kare o shinrai shite iru.',
        'example_vn': 'Tôi tin cậy anh ấy.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '恐れる',
        'hiragana': 'おそれる',
        'romaji': 'osoreru',
        'options': ['tiến cử', 'tin cậy', 'mạng sống', 'sợ hãi'],
        'answer': 'sợ hãi',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'N / V(ru) + とあれば',
            'meaning': 'Nếu là (vì) ... thì đành chịu (chấp nhận)',
          },
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_osoreru.png',
            'jp': '恐れる',
            'rmj': 'osoreru',
          },
          {
            'img': 'assets/images/example_shinrai.png',
            'jp': '信頼',
            'rmj': 'shinrai',
          },
          {
            'img': 'assets/images/example_suisen.png',
            'jp': '推薦',
            'rmj': 'suisen',
          },
          {
            'img': 'assets/images/example_inochi.png',
            'jp': '命',
            'rmj': 'inochi',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Nếu là vì công việc thì đành chịu): \n仕事のため ( ... )、仕方がない。',
    ...
    return [
      {
        ...
        'kanji_word': '命',
        'kanji_target': '命',
        'meaning': 'Mệnh (Sinh mệnh / Ra lệnh)',
        'rmj': 'inochi / mei',
      },
      {
        'type': LessonType.kanjiDraw,
  ...
  List<Map<String, dynamic>> _getN1Bai9LyThuyetData() {
    return [
      ...
      },
      {
        ...
        'example_jp': '家族が崩壊する。',
        'example_rmj': 'Kazoku ga houkai suru.',
        'example_vn': 'Gia đình sụp đổ.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '批判',
        'hiragana': 'ひはん',
        'romaji': 'hihan',
        'options': ['nợ nần', 'chịu đựng', 'phê phán', 'kết cục'],
        'answer': 'phê phán',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'V(ru) + しまつだ',
            'meaning': 'Kết cục là... / Rốt cuộc thì... (Rất tồi tệ)',
          },
          {
            'title': 'V(ru) / N + に堪えない',
            'meaning': 'Không đáng để... / Không thể chịu nổi...',
          },
        ],
      },
      {
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_shakkin.png',
            'jp': '借金',
            'rmj': 'shakkin',
          },
          {
            'img': 'assets/images/example_taeru.png',
            'jp': '堪える',
            'rmj': 'taeru',
          },
          {
          ...
          {
            'img': 'assets/images/example_houkai.png',
            'jp': '崩壊',
            'rmj': 'houkai',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Nợ nần chồng chất, KẾT CỤC là bán nhà): \n家を売る ( ... )。',
    ...
    return [
      {
        ...
        'words': [
          ...
          },
          {
            ...
            'hiragana': 'いっしゅん',
            'romaji': 'isshun',
            'meaning': 'Một khoảnh khắc / Chốc lát',
          },
          {
            'kanji': '無駄',
            'hiragana': 'むだ',
      ...
      },
      {
        ...
        'example_jp': '想像できない。',
        'example_rmj': 'Souzou dekinai.',
        'example_vn': 'Không thể tưởng tượng được.',
      },
      {
        'type': LessonType.flashCard,
        'kanji': '一瞬',
        'hiragana': 'いっしゅん',
        'romaji': 'isshun',
        'meaning': 'Một khoảnh khắc',
        'example_img': 'assets/images/example_isshun.png',
        'example_jp': '一瞬の出来事。',
        'example_rmj': 'Isshun no dekigoto.',
        'example_vn': 'Sự việc xảy ra trong chốc lát.',
      },
      {
        'type': LessonType.vocabQuiz,
        'kanji': '無駄',
        'hiragana': 'むだ',
        'romaji': 'muda',
        'options': ['kẻ thù', 'tưởng tượng', 'lãng phí', 'tha thứ'],
        'answer': 'lãng phí',
      },
      {
        'type': LessonType.grammarListIntro,
        'grammars': [
          {
            'title': 'N + (で)すら',
            'meaning': 'Ngay cả... (Nhấn mạnh một điều hiển nhiên)',
          },
          {
            'title': '1+Từ đếm + たりとも...ない',
            'meaning': 'Dù chỉ là (1)... cũng không...',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        'vn':
            'DÙ CHỈ LÀ một khoảnh khắc, tôi cũng sẽ không tha thứ cho kẻ thù.',
      },
      {
        'type': LessonType.vocabSummary,
        'words': [
    ...
    return [
      {
        ...
        'options': [
          {
            'img': 'assets/images/example_souzou.png',
            'jp': '想像',
            'rmj': 'souzou',
          },
          ...
          {
            'img': 'assets/images/example_yurusu.png',
            'jp': '許す',
            'rmj': 'yurusu',
          },
        ],
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Điền từ (Ngay cả tên mình cũng không viết được): \n自分の名前 ( ... ) 書けない。',
    ...
    return [
      {
        'type': LessonType.quiz,
        'question':
            'Cấu trúc luôn đi với số "1" và mang nghĩa phủ định hoàn toàn:',
  ...
  List<Map<String, dynamic>> _getN1Bai10LuyenNoiData() {
    return [
      {'type': LessonType.speaking, 'jp': '名前すら書けない。', 'answer': 'なまえすらかけない'},
      {
        'type': LessonType.speaking,
        'jp': '一瞬たりとも忘れない。',
        'answer': 'いっしゅんたりともわすれない',
      },
      {
        'type': LessonType.speaking,
        'jp': '一日たりとも無駄にしない。',
        'answer': 'いちにちたりともむだにしない',
      },
    ];
  }
    ...
    return [
      {
        ...
        'kanji_word': '想像',
        'kanji_target': '想',
        'meaning': 'Tưởng (Tư tưởng / Tưởng tượng)',
        'rmj': 'sou',
      },
      {
        'type': LessonType.kanjiDraw,
        'kanji_word': '想像',
        'kanji_target': '像',
        'meaning': 'Tượng (Hình tượng / Tưởng tượng)',
        'rmj': 'zou',
      },
      {
        'type': LessonType.kanjiDraw,
      ...
      },
      {
        ...
        'kanji_word': '無駄',
        'kanji_target': '駄',
        'meaning': 'Đà (Vô ích / Lãng phí)',
        'rmj': 'da',
      },
    ];
  }

  List<Map<String, dynamic>> _generateAlphabetData(
    List<Map<String, String>> chars,
  ) {
    List<Map<String, dynamic>> data = [];
    ...
    for (var c in chars) {
      ...
      hiraOptions.shuffle();
      List<String> finalHiraOptions = [c['hira']!, ...hiraOptions.take(3)]
        ..shuffle();
      ...
      kataOptions.shuffle();
      List<String> finalKataOptions = [c['kata']!, ...kataOptions.take(3)]
        ..shuffle();
    ...
    data.add({
      'type': LessonType.matching,
      'pairs': chars
          .map((c) => {'left': c['romaji']!, 'right': c['hira']!})
          .toList(),
    });
    ...
    data.add({
      'type': LessonType.matching,
      'pairs': chars
          .map((c) => {'left': c['hira']!, 'right': c['kata']!})
          .toList(),
    });
  ...
  List<Map<String, dynamic>> _getFinalReviewData() {
    ...
    for (var c in allChars.take(8)) {
      ...
      List<String> options = allChars
          .map((e) => isHira ? e['hira']! : e['kata']!)
          .toList();
    ...
    data.add({
      ...
      'pairs': allChars
          .take(5)
          .map((c) => {'left': c['romaji']!, 'right': c['kata']!})
          .toList(),
    });
    allChars.shuffle();
    data.add({
  ...
  Widget _buildMatchingView(Map<String, dynamic> data) {
    List<Map<String, String>> matchingPairs = (data['pairs'] as List)
...
class _VocabQuizViewState extends State<VocabQuizView> {
  ...
  Widget build(BuildContext context) {
    ...
    String mainText = kanji.isNotEmpty ? kanji : hiragana;
    bool showFurigana = kanji.isNotEmpty && kanji != hiragana;
    double dynamicFontSize = mainText.length > 4
        ? 24
        : (mainText.length > 2 ? 40 : 48);
    return Column(
      children: [
        const Text(
